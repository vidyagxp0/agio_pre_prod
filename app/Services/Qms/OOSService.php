...
// dd($request->file('oos_detail'));
        ...
        $history = new OosAuditTrial();
        $history->oos_id = $lastOosRecod->id;
        $history->previous = strip_tags($lastOosRecod->Any_other_cause);
        $history->activity_type = 'Any other cause/suspected cause';
        $history->current = strip_tags($request->Any_other_cause);
        $history->comment = "Not Applicable";
        $history->user_id = Auth::user()->id;
        $history->user_name = Auth::user()->name;
        $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
        ...
        $history->save();
                ...
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = strip_tags($lastOosRecod->Any_other_batches);
                $history->activity_type = 'Any other batches analyzed';
                $history->current = strip_tags($request->Any_other_batches);
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
        ...
        if ($lastOosRecod->details_of_trend !=  $request->details_of_trend || !empty($request->details_of_trend_comment)) {
            ...
            $history = new OosAuditTrial();
            $history->oos_id = $lastOosRecod->id;
            $history->previous = strip_tags($lastOosRecod->details_of_trend);
            $history->activity_type = 'Details of trend';
            $history->current = strip_tags($request->details_of_trend);
            $history->comment = "Not Applicable";
            $history->user_id = Auth::user()->id;
            $history->user_name = Auth::user()->name;
            $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
        ...
        $history = new OosAuditTrial();
        $history->oos_id = $lastOosRecod->id;
        $history->previous = strip_tags($lastOosRecod->rational_for_assingnable);
        $history->activity_type = 'Assignable cause and rational for assignable cause';
        $history->current = strip_tags($request->rational_for_assingnable);
        $history->comment = "Not Applicable";
        $history->user_id = Auth::user()->id;
        $history->user_name = Auth::user()->name;
        $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
    ...
    if (is_null($lastOosRecod->justification_ib) || $lastOosRecod->justification_ib === '') {
        ...
        if ($lastOosRecod->stage == 13) {
            ...
            // if ($lastOosRecod->Laboratory_Investigation_Hypothesis != $request->Laboratory_Investigation_Hypothesis){
                ...
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = strip_tags($lastOosRecod->Laboratory_Investigation_Hypothesis);
                $history->activity_type = 'Laboratory Investigation Hypothesis Details';
                $history->current = strip_tags($request->Laboratory_Investigation_Hypothesis);
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // if ($lastOosRecod->Outcome_of_Laboratory != $request->Outcome_of_Laboratory){
                ...
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = strip_tags($lastOosRecod->Outcome_of_Laboratory);
                $history->activity_type = 'Outcome of Laboratory Investigation';
                $history->current = strip_tags($request->Outcome_of_Laboratory);
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // if ($lastOosRecod->Evaluation_IIB != $request->Evaluation_IIB){
                ...
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = strip_tags($lastOosRecod->Evaluation_IIB);
                $history->activity_type = 'Evaluation';
                $history->current = strip_tags($request->Evaluation_IIB);
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // if ($lastOosRecod->If_assignable_cause != $request->If_assignable_cause){
                ...
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = strip_tags($lastOosRecod->If_assignable_cause);
                $history->activity_type = 'If Assignable Cause Identified Perform Re-Testing';
                $history->current = strip_tags($request->If_assignable_cause);
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
            ...
            // if ($lastOosRecod->If_assignable_error != $request->If_assignable_error){
                ...
                $history = new OosAuditTrial();
                $history->oos_id = $lastOosRecod->id;
                $history->previous = strip_tags($lastOosRecod->If_assignable_error);
                $history->activity_type = 'If assignable Error Is Not Identified Proceed As Per Phase III Investigation';
                $history->current = strip_tags($request->If_assignable_error);
                $history->comment = "Not Applicable";
                $history->user_id = Auth::user()->id;
                $history->user_name = Auth::user()->name;
                $history->user_role = RoleGroup::where('id', Auth::user()->role)->value('name');
