...
class OOS extends Model
{
    ...
    protected $casts = [
      'Comments_plidata' => 'array', // Example: Casts 'your_attribute' to a boolean
      // 'justify_if_no_field_alert_pli' => 'array',
      ...
      // 'review_comments_plir' => 'array',
       ...
       //'summary_of_exp_hyp_piiqcr' => 'array',
    ...
    //   'review_comment_atp' => 'array',
       'additional_test_reference_atp' => 'array',
      // 'conclusion_comments_oosc' => 'array',
     //  'justifi_for_averaging_results_oosc' => 'array',
     //  'justify_if_capa_not_required_oosc' => 'array',//tab5
       'action_plan_ref_oosc' => 'array',
      // 'justification_for_delay_oosc' => 'array',
      // 'conclusion_review_comments_ocr' => 'array',
     //  'action_taken_on_affec_batch_ocr' => 'array',
       'capa_refer_ocr' => 'array',//tab6
       'action_task_reference_ocr' => 'array',
       'risk_assessment_ref_ocr' => 'array',
     //  'justify_if_no_risk_assessment_ocr' => 'array',
     //  'cq_review_comments_ocqr' => 'array',
       // 'other_action_bd' => 'array',
       'field_alert_reference_bd' => 'array',
      //   'other_parameters_results_bd' => 'array',
     //  'trend_of_previous_batches_bd' => 'array',
         //'stability_data_bd' => 'array',
       //'process_validation_data_bd' => 'array',
       // 'method_validation_bd' => 'array',
        //'any_market_complaints_bd' => 'array',
       // 'statistical_evaluation_bd' => 'array',
      //  'risk_analysis_disposition_bd' => 'array',
      // 'conclusion_bd' => 'array',
       'phase_inves_reference_bd' => 'array',
     //   'justify_for_delay_in_activity_bd' => 'array',
      //  'other_action_specify_ro' => 'array',
      //  'reopen_approval_comments_uaa' => 'array',//tab6
     //  'execution_comments_uae' => 'array',
