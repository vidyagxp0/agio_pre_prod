...
class ActionItemController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $due_date_data = Capa::where('id', $data->parent_id)->value('due_date');
        // $due_date_data = RiskManagement::where('id', $data->parent_id)->value('due_date');
        $due_date_data = OOS::where('id', $data->parent_id)->value('due_date');
        $due_date_data = OutOfCalibration::where('id', $data->parent_id)->value('due_date');
        $due_date_data = Auditee::where('id', $data->parent_id)->value('due_date');
        $due_date_data = MarketComplaint::where('id', $data->parent_id)->value('due_date');
        // $due_date_data = ManagementReview::where('id', $data->parent_id)->value('due_date');
        $due_date_data = CC::where('id', $data->parent_id)->value('due_date');
        $due_date_data = InternalAudit::where('id', $data->parent_id)->value('due_date');
        $due_date_data = Observation::where('id', $data->parent_id)->value('due_date');
        $cc = CC::find($data->cc_id);
