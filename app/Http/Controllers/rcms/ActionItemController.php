    ...
    public function stageChange(Request $request, $id)
    {
        ...
        if (strtolower($request->username) == strtolower(Auth::user()->email) && Hash::check($request->password, Auth::user()->password)) {
            ...
            if ($changeControl->stage == 2) {
                ...
                //             Mail::send(
                //                 'mail.view-mail',
                //                 ['data' => $changeControl, 'site' => "AI", 'history' => "Acknowledge Complete", 'process' => 'Action Item', 'comment' => $request->comment, 'user'=> Auth::user()->name],
                //                 function ($message) use ($email, $changeControl) {
                //                     $message->to($email)
            ...
            if ($changeControl->stage == 3) {
                ...
                //             Mail::send(
                //                 'mail.view-mail',
                //                 ['data' => $changeControl, 'site' => "AI", 'history' => "Complete", 'process' => 'Action Item', 'comment' => $request->comment, 'user'=> Auth::user()->name],
                //                 function ($message) use ($email, $changeControl) {
                //                     $message->to($email)
            ...
            if ($changeControl->stage == 4) {
                ...
                //             Mail::send(
                //                 'mail.view-mail',
                //                 ['data' => $changeControl, 'site' => "AI", 'history' => "Verification Complete", 'process' => 'Action Item', 'comment' => $request->comment, 'user'=> Auth::user()->name],
                //                 function ($message) use ($email, $changeControl) {
                //                     $message->to($email)
...
public function actionStageCancel(Request $request, $id)
{
    if (strtolower($request->username) == strtolower(Auth::user()->email) && Hash::check($request->password, Auth::user()->password)) {
        ...
        if ($changeControl->stage == 1) {
            ...
            //                 Mail::send(
            //                     'mail.view-mail',
            //                     ['data' => $changeControl, 'site' => "AI", 'history' => "Cancel", 'process' => 'Action Item', 'comment' => $request->comment, 'user'=> Auth::user()->name],
            //                     function ($message) use ($email, $changeControl) {
            //                         $message->to($email)
...
public function actionmoreinfo(Request $request, $id)
{
        ...
        if ($changeControl->stage == 2) {
            ...
            //                 Mail::send(
            //                     'mail.view-mail',
            //                     ['data' => $changeControl, 'site' => "AI", 'history' => "More Information Required", 'process' => 'Action Item', 'comment' => $request->comment, 'user'=> Auth::user()->name],
            //                     function ($message) use ($email, $changeControl) {
            //                         $message->to($email)
