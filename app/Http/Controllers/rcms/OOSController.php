...
foreach ($list as $u) {
    ...
    try {
        ...
        // Agar email fail ho jaye to yahan handle karein
        \Log::error("Mail sending failed for user {$u->user_id}: " . $e->getMessage());
    }
}
...
foreach ($list as $u) {
    ...
    try {
        ...
        // Error ko log karein
        \Log::error("Mail sending failed for QA user {$u->user_id}: " . $e->getMessage());
    }
