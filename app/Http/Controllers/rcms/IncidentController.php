...
class IncidentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (is_array($request->Description_Deviation)) {
            $incident->Description_Deviation = implode(',', $request->Description_Deviation);
        }
        ...
        $incident->incident_category = $request->Deviation_category;
    ...
    public function incidentShow($id)
    {
        ...
        return view('frontend.incident.incident_view', compact('data', 'old_record','divisionName','grid_data1','grid_data2','investigationExtension','investigation_data','root_cause_data','fishbone_data','why_data','qrmExtension','grid_data_qrms','grid_data_matrix_qrms','capaExtension','data1','incidentExtension'));    
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $newDataGridqrms = incidentGridQrms::where(['incident_id' => $id, 'identifier' => 'failure_mode_qrms'])->firstOrCreate();
