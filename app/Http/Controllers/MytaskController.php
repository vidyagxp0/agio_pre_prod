...
class MytaskController extends Controller
{
        ...
        public function index(Request $request)
    {
        ...
        $processes = [
            ...
            'RiskAssessment' => ['model' => RiskManagement::class, 'name' => 'Risk Assessment'],
            'RootCauseAnalysis' => ['model' => RootCauseAnalysis::class, 'name' => 'Root Cause Analysis'],
            'Change Proposal And Justification' => ['model' => ChangeProposalJust::class, 'name' => 'Change Proposal And Justification'],
        ];
        ...
        $stages = [
            ...
            'AuditProgram' => [
                ['id' => 1, 'status' => 'Opened', 'role' => [7,66]],
                ['id' => 2, 'status' => 'Pending Approval', 'role' => [42,65]],
                ['id' => 3, 'status' => 'Pending Audit', 'role' => [49, 63]],
            ],
            'Capa' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'HOD Review', 'role' => 4],
                ['id' => 3, 'status' => 'QA/CQA Review', 'role' => [7,63,49,66]],
                ['id' => 4, 'status' => 'QA/CQA Approval', 'role' => [7,66,64,67,]],
                ['id' => 5, 'status' => 'CAPA In progress', 'role' => 3],
                ['id' => 6, 'status' => 'HOD Final Review', 'role' => 4],
                ['id' => 7, 'status' => 'QA/CQA Closure Review', 'role' => [7,66,48,49,63]],
                ['id' => 8, 'status' => 'QAH/CQA Head Approval', 'role' => [9, 65]],
            ],
            'CC' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'HOD Assessment', 'role' => 4],
                ['id' => 3, 'status' => 'QA/CQA Initial Assessment', 'role' => [7, 66,48,49,63]],
                ['id' => 4, 'status' => 'CFT Assessment', 'role' => 5],
                ['id' => 5, 'status' => 'QA/CQA Final Review', 'role' => [7, 66,48,49,63]],
                ['id' => 6, 'status' => 'Pending RA Approval', 'role' => 50],
                ['id' => 7, 'status' => 'QA/CQA Head/Manager Designee Approval', 'role' => [39,42,43,9]],
                ['id' => 8, 'status' => 'Pending Initiator Update', 'role' => 3],
                ['id' => 9, 'status' => 'HOD Final Review', 'role' => 4],
                ['id' => 10, 'status' => 'Implementation verification by QA/CQA', 'role' => [7, 66]],
                ['id' => 11, 'status' => 'QA/CQA Closure Approval', 'role' => [39,42,43,65,9]],
            ],
            'Deviation' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'HOD Review', 'role' => 4],
                ['id' => 3, 'status' => 'QA/CQA Initial Assessment', 'role' => [7, 66,48,49,63]],
                ['id' => 4, 'status' => 'CFT Review', 'role' => 5],
                ['id' => 5, 'status' => 'QA/CQA Final Assessment', 'role' => [7, 66,48,49,63]],
                ['id' => 6, 'status' => 'QA/CQA Head/Manager Designee Approval', 'role' => [39,42,43,9,65]],
                ['id' => 7, 'status' => 'Pending Initiator Update', 'role' => 3],
                ['id' => 8, 'status' => 'HOD Final Review', 'role' => 4],
                ['id' => 9, 'status' => 'Implementation verification by QA/CQA', 'role' => [7, 66,48,49,63]],
                ['id' => 10, 'status' => 'Head QA/CQA Designee Closure Approval', 'role' => [43, 65,]],
                ['id' => 11, 'status' => 'Pending Cancellation', 'role' => 7],
            ],
            'EffectivenessCheck' => [
                ...
                ['id' => 3, 'status' => 'Work Completion', 'role' => 18],
                ['id' => 4, 'status' => 'HOD Review', 'role' => 4],
                ['id' => 5, 'status' => 'QA/CQA Review', 'role' => [7,48,49,63,66]],
                ['id' => 6, 'status' => 'QA/CQA Approval-Effective', 'role' => [9,67,43,64,65]],
                ['id' => 7, 'status' => 'QA/CQA Approval-Not Effective', 'role' => [9,67,43,64,65]],
            ],
            'Errata' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'HOD Review', 'role' => 4],
                ['id' => 3, 'status' => 'QA/CQA Initial Review', 'role' => [7, 66,48,49,63]],
                ['id' => 4, 'status' => 'QA/CQA Approval', 'role' => [9,43,65,54,67]],
                ['id' => 5, 'status' => 'Pending Correction', 'role' => 3],
                ['id' => 6, 'status' => 'Pending HOD Review', 'role' => 4],
                ['id' => 7, 'status' => 'Pending QA/CQA Head Approval', 'role' => [9,43,65,54,67]],
            ],
            'Extension' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'In Review', 'role' => 4],
                ['id' => 3, 'status' => 'In Approval', 'role' => [64,66,67,7]],
                ['id' => 4, 'status' => 'In CQA Approval', 'role' => 64],
            ],
            'ExternalAudit' => [
                ['id' => 1, 'status' => 'Opened', 'role' => [7,48,63,66]],
                ['id' => 2, 'status' => 'Summary and Response', 'role' => [7,48,63,66]],
                ['id' => 3, 'status' => 'CFT Review', 'role' => 5],
                ['id' => 4, 'status' => 'QA/CQA Head Approval', 'role' => [43,64,67,65,9]],
            ],
            'Incident' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'HOD Initial Review', 'role' => 4],
                ['id' => 3, 'status' => 'QA Initial Review', 'role' => [7,48,49]],
                ['id' => 4, 'status' => 'QAH/Designee Approval', 'role' => [9,42,43,67]],
                ['id' => 5, 'status' => 'Pending Initiator Update', 'role' => 3],
                ['id' => 6, 'status' => 'HOD Final Review', 'role' => 4],
                ['id' => 7, 'status' => 'QA Final Review', 'role' => [48,49]],
                ['id' => 8, 'status' => 'QAH Approval', 'role' => [9,42,43,67]],
            ],
            'InternalAudit' => [
                ['id' => 1, 'status' => 'Opened', 'role' => [7,43,49,48,66]],
                ['id' => 2, 'status' => 'Acknowledgment', 'role' => [11,12]],
                ['id' => 3, 'status' => 'Pending Audit', 'role' => 12],
                ['id' => 4, 'status' => 'Pending Response', 'role' => 11],
                ['id' => 5, 'status' => 'Response Verification', 'role' => 13],
            ],
            'LabIncident' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'QC Head/HOD Initial Review', 'role' => [4,45,10]],
                ['id' => 3, 'status' => 'QA Initial Review', 'role' => [7,48,49]],
                ['id' => 4, 'status' => 'Pending Initiator Update', 'role' => 3],
                ['id' => 5, 'status' => 'QC Head/HOD Secondary Review', 'role' => [4,45,10]],
                ['id' => 6, 'status' => 'QA Secondary Review', 'role' => [7,48,49]],
                ['id' => 7, 'status' => 'QAH Approval', 'role' => [9,42,67,42]],
            ],
            'ManagementReview' => [
                ['id' => 1, 'status' => 'Opened', 'role' => [7,48,49]],
                ['id' => 2, 'status' => 'QA Head Review', 'role' => [42,9,43,67]],
                ['id' => 3, 'status' => 'Meeting and Summary', 'role' => [7,48,49]],
                ['id' => 4, 'status' => 'CFT Action', 'role' => 5],
                ['id' => 5, 'status' => 'CFT HOD Review', 'role' => [4, 5]],
                ['id' => 6, 'status' => 'QA Verification', 'role' => [7,48,49]],
                ['id' => 7, 'status' => 'QA Head Closure Approval', 'role' => [42,9,43,67]],
            ],
            'MarketComplaint' => [
                ['id' => 1, 'status' => 'Opened', 'role' => [7,48,49,66,63]],
                ['id' => 2, 'status' => 'QA/CQA Head Review', 'role' => [9,43,64,65]],
                ['id' => 3, 'status' => 'Investigation, CAPA and Root Cause Analysis', 'role' => [7,48,49,66,63]],
                ['id' => 4, 'status' => 'CFT Review', 'role' => 5],
                ['id' => 5, 'status' => 'All Action Completion Verification by QA/CQA', 'role' => [7,48,49,66,53]],
                ['id' => 6, 'status' => 'QA/CQA Head Approval', 'role' => [9,64,65,67]],
                ['id' => 7, 'status' => 'Pending Response Letter', 'role' => [7,48,49,66,63]],
            ],
            'Observation' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 12],
                ['id' => 2, 'status' => 'Pending Response', 'role' => 11],
                ['id' => 3, 'status' => 'Response Verification', 'role' => [13,63,48,49,66]],
            ],
            'OOC' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'HOD Primary Review', 'role' => 4],
                ['id' => 3, 'status' => 'QA Head Primary Review', 'role' => [9,43,39,42,67]],
                ['id' => 4, 'status' => 'Under Phase-IA Investigation', 'role' => 3],
                ['id' => 5, 'status' => 'Phase IA HOD Primary Review', 'role' => 4],
                ['id' => 6, 'status' => 'Phase IA QA Review', 'role' => [7,48,49]],
                ['id' => 7, 'status' => 'P-IA QAH Review', 'role' => [9,42,43,67]],
                ['id' => 8, 'status' => 'Under Phase-IB Investigation', 'role' => 3],
                ['id' => 9, 'status' => 'Phase IB HOD Primary Review', 'role' => 4],
                ['id' => 10, 'status' => 'Phase IB QA Review', 'role' => [7,48,49]],
                ['id' => 11, 'status' => 'P-IB QAH Review', 'role' => [9,43,39,42,67]],
            ],
            'OOSOOT' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'HOD Primary Review', 'role' => 4],
                ['id' => 3, 'status' => 'QA Head Approval', 'role' => [42,67]],
                ['id' => 4, 'status' => 'CQA/QA Head Primary Review', 'role' => [42,64,65,6,67]],
                ['id' => 5, 'status' => 'Under Phase-IA Investigation', 'role' => 3],
                ['id' => 6, 'status' => 'Phase IA HOD Primary Review', 'role' => 4],
                ['id' => 7, 'status' => 'Phase IA QA/CQA Review', 'role' => [7,48,49,63,66]],
                ['id' => 8, 'status' => 'P-IA CQAH/QAH Review', 'role' => [42,43,9,64,65,66,67]],
                ['id' => 9, 'status' => 'Under Phase-IB Investigation', 'role' => 3],
                ['id' => 10, 'status' => 'Phase IB HOD Primary Review', 'role' => 4],
                ['id' => 11, 'status' => 'Phase IB QA/CQA Review', 'role' => [7,48,49,63,66]],
                ['id' => 12, 'status' => 'P-IB CQAH/QAH Review', 'role' => [42,43,9,64,65,66,67]],
            ],
            'Resampling' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'Head QA/CQA Approval', 'role' => [42,43,9,64,65,66,67]],
                ['id' => 3, 'status' => 'Acknowledge', 'role' => [8, 18]],
                ['id' => 4, 'status' => 'QA/CQA Verification', 'role' => [7,48,49,63,66]],
            ],
            'RiskAssessment' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'Risk Analysis & Work Group Assignment', 'role' => 4],
                ['id' => 3, 'status' => 'CFT Review', 'role' => 5],
                ['id' => 4, 'status' => 'In QA/CQA Review', 'role' => [7, 48,49,63,66]],
                ['id' => 5, 'status' => 'In Approval', 'role' => [42,43,9,64,65,66,67]],
            ],
            'RootCauseAnalysis' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'HOD Review', 'role' => 4],
                ['id' => 3, 'status' => 'Initial QA/CQA Review', 'role' => [7,48,49,63,66]],
                ['id' => 4, 'status' => 'Investigation In progress', 'role' => 3],
                ['id' => 5, 'status' => 'HOD Final Review', 'role' => 4],
                ['id' => 6, 'status' => 'Final QA/CQA Review', 'role' => [7,48,49,63,66]],
                ['id' => 7, 'status' => 'QAH/CQAH Final Review', 'role' => [42,43,9,64,65,66,67]],
            ],
             'Change Proposal And Justification' => [
                ['id' => 1, 'status' => 'Opened', 'role' => 3],
                ['id' => 2, 'status' => 'HOD Review', 'role' => 4],
                ['id' => 3, 'status' => 'QA/CQA Review', 'role' => [7,48,49,63,66]],
                ['id' => 4, 'status' => 'QA/CQA Head / Designe', 'role' => [42,43,9,64,65,66,67]],
            ],
        ];
        ...
        $routes = [
            ...
            'Change Proposal And Justification' => 'cpshow',
        ];
