          ...
          <g id="train">
            ...
            <g id="car-layers">
              ...
              <g id="Text">
                ...
                <text transform="translate(659.5 213.994)" class="st8 st10" font-size="24.025" style="font-size: 13px">
                  It seems to be a user role related issue
                </text>
              </g>
              <g id="ladders">
                <g id="ladder-f">
  ...
  a{
    ...
    <div class="bottom">
      <div class="Previous-page" >
        You can navigate back to the <a href="#">Previous Page</a> or return to the <a href="#">Desktop</a>
      </div>
    </div>
  </body>
</html>
