                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $doc->name }}</td>
                            <td>
                                <a class="mdi mdi-table-edit" href="{{ route('document_types.edit', $doc->id) }}"><button class="btn btn-dark">Edit</button></a>

                                <form action="{{ route('document_types.destroy', $doc->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')

                                    <button type="submit" class="confirmation btn btn-danger" title="Delete" onclick="return confirm('Are You sure')">Delete</button>
                                </form>
                            </td>
                        </tr>
                        @endforeach
...
<div class="modal fade" id="modal-default">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('document_types.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="name" name="typecode" class="form-control" id="exampleInputName1" placeholder="Enter Code" required>
                        </div>
                        <div class="form-group">
