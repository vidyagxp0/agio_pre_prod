    ...
    <div class="inner-block">
        <div class="content-table">
           ...
           <tr>
                            ...
                            @if ($grid_Data && is_array($grid_Data->data))
                                @foreach ($grid_Data->data as $grid_Data)
                                    <tr>
                                        ...
                                        <td class="w-20">
                                            {{ isset($grid_Data['regulatoryagency']) ? $grid_Data['regulatoryagency'] : '' }}</td>
                                        <td class="w-20">
                                            {{ isset($grid_Data['designation']) ? $grid_Data['designation'] : '' }}</td>
                            ...
                            @if ($grid_Data_2 && is_array($grid_Data_2->data))
                                @foreach ($grid_Data_2->data as $grid_Data_2)
                                    <tr>
                                        ...
                                        <td class="w-20">
                                            {{ isset($grid_Data_2['reference_id']) ? $grid_Data_2['reference_id'] : '' }}</td>
            ...
            <div class="border-table">
                <div class="block-head">
                Summary And Response Attachmentss
                </div>
                <table>
