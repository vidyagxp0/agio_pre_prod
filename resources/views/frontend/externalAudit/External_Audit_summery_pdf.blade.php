    ...
    <header>
        ...
        <table>
            <tr>
                ...
                <td class="w-40">
                    {{ Helpers::getDivisionName($data->division_id) }}/EA/{{ date('Y') }}/{{ $data->record ? str_pad($data->record, 4, '0', STR_PAD_LEFT) : '' }}
                </td>
                <td class="w-30">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="no-record">
                            No Action Item has been created from this External Audit.
                        </td>
                    </tr>
                @endforelse
            </tbody>
