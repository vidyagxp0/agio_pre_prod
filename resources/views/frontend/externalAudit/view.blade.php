    ...
    @enderror
                                ...
                                <div class="col-md-12 mb-3 other1_reviews">
                                    <div class="group-input">
                                        ...
                                        <textarea class="tiny1" name="Other1_assessment" id="summernote-41" @if ($data->stage != 3 || Auth::user()->name != $data1->Other1_person) readonly @endif>{{ $data1->Other1_assessment }}</textarea>
                                    </div>
                                </div>
...
{{--
                            ...
                            <div class="col-md-12 mb-3 Other2_reviews">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny1" name="Other2_Assessment" id="summernote-43" @if ($data->stage != 3 || Auth::user()->name != $data1->Other2_person) readonly @endif>{{ $data1->Other2_Assessment }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mb-3 Other3_reviews">
                                <div class="group-input">
                                    ...
                                    <textarea class="tiny1" name="Other3_Assessment" id="summernote-45" @if ($data->stage != 3 || Auth::user()->name != $data1->Other3_person) readonly @endif>{{ $data1->Other3_Assessment }}</textarea>
                                </div>
                            </div>
