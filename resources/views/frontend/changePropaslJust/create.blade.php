                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="checklist[{{ $key }}][response]"
                                                                    ...
                                                                    <option value="No"
                                                                        {{ isset($savedChecklist[$key]['response']) && $savedChecklist[$key]['response']=='No' ? 'selected' : 'disabled' }}>
                                                                        No
                                                                    </option>

                                                                    <option value="N/A"
                                                                        {{ isset($savedChecklist[$key]['response']) && $savedChecklist[$key]['response']=='N/A' ? 'selected' : 'disabled' }}>
                                                                        N/A
                                                                    </option>
