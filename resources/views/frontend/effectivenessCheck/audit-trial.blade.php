            ...
            <div class="audit-trial-container">
                ...
                <div class="inner-block">
                    <div class="main-head">
                        ...
                        {{ Helpers::getDivisionName(session()->get('division')) }}/EC/{{ date('Y') }}/{{ str_pad($document->record, 4, '0', STR_PAD_LEFT) }}</div>
                                ...
                                @foreach ($audit as $audits)
                                    <tr>
                                        <td class="viewdetails"><a
                                                href="{{ url('rcms/effective-audit-trial-details', $audits->id) }}">{{ $audits->activity_type }}</a>
                                        </td>
