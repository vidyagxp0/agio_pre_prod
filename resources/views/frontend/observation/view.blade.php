            ...
            <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        @if ($data->stage == 1 && (Auth::user()->id == $data->initiator_id || Helpers::check_roles($data->division_id, 'Observation', 18)))
                        ...
                        @elseif($data->stage == 2 && (Auth::user()->id == $data->assign_to || Helpers::check_roles($data->division_id, 'Observation', 18)))
