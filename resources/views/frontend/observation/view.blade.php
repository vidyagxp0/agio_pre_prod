...
<style>
 ...
 @endif
                            ...
                            <div id="CCForm1" class="inner-block cctabcontent">
                                ...
                                <div class="col-12">
                                 ...
                                 <!-- Hidden field to keep track of files to be deleted -->
                                    <input type="hidden" id="deleted_attach_files_gi" name="deleted_attach_files_gi"
                                        value="">
                                            ...
                                            removeButtons.forEach(button => {
                                                button.addEventListener('click', function() {
                                                    ...
                                                    if (fileContainer) {
                                                        ...
                                                        const deletedFilesInput = document.getElementById('deleted_attach_files_gi');
  ...
  <!-- Hidden field to keep track of files to be deleted -->
                                    <input type="hidden" id="deleted_response_capa_attach" name="deleted_response_capa_attach"
                                        value="">
                                            ...
                                            removeButtons.forEach(button => {
                                                button.addEventListener('click', function() {
                                                    ...
                                                    if (fileContainer) {
                                                        ...
                                                        // Add the file name to the deleted files list
                                                        const deletedFilesInput = document.getElementById('deleted_response_capa_attach');
                                                        let deletedFiles = deletedFilesInput.value ? deletedFilesInput.value.split(
                                                            ',') : [];
                                                        deletedFiles.push(fileName);
                                                        deletedFilesInput.value = deletedFiles.join(',');
                            ...
                            <div id="CCForm4" class="inner-block cctabcontent">
                                ...
                                <div class="col-12">
                                 ...
                                 <!-- Hidden field to keep track of files to be deleted -->
                                    <input type="hidden" id="deleted_impact_analysis" name="deleted_impact_analysis"
                                        value="">
                                            ...
                                            removeButtons.forEach(button => {
                                                button.addEventListener('click', function() {
                                                    ...
                                                    if (fileContainer) {
                                                        ...
                                                        // Add the file name to the deleted files list
                                                        const deletedFilesInput = document.getElementById('deleted_impact_analysis');
                                                        let deletedFiles = deletedFilesInput.value ? deletedFilesInput.value.split(
                                                            ',') : [];
                                                        deletedFiles.push(fileName);
                                                        deletedFilesInput.value = deletedFiles.join(',');
                                ...
                                <div class="inner-block-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                         ...
                                         <!-- Hidden field to keep track of files to be deleted -->
                                    <input type="hidden" id="deleted_attach_files2" name="deleted_attach_files2"
                                        value="">
                                            ...
                                            removeButtons.forEach(button => {
                                                button.addEventListener('click', function() {
                                                    ...
                                                    if (fileContainer) {
                                                        ...
                                                        // Add the file name to the deleted files list
                                                        const deletedFilesInput = document.getElementById('deleted_attach_files2');
                                                        let deletedFiles = deletedFilesInput.value ? deletedFilesInput.value.split(
                                                            ',') : [];
                                                        deletedFiles.push(fileName);
                                                        deletedFilesInput.value = deletedFiles.join(',');
