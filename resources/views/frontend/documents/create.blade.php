        ...
        <form id="document-form" action="{{ route('documents.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-8">
                <div class="group-input">
                    ...
                    <select multiple name="notify_to[]" placeholder="Select Persons" data-search="false" data-silent-initial-value-set="true" id="notify_to">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="group-input">
                ...
                <select id="choices-multiple-remove-button" class="choices-multiple-reviewer" name="hods[]" placeholder="Select HOD's" multiple required>
                    @foreach ($hods as $hod)
                    <option value="{{ $hod->id }}">
                        {{ $hod->name }}
                    </option>
