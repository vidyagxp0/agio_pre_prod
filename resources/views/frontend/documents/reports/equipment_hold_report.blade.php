...
<h1>XX EQUIPMENT HOLD TIME STUDY REPORT</h1>
<h2>Report No. :  XX</h2>
...
.body {
    ...
    .block-head {
        text-align: center; /* Center align the "REPORT APPROVAL" */
        font-weight: bold; /* Optional: To make the text bold */
        border: none; /* Remove the underline or black border */
    }

    .block {
        margin-bottom: 40px;
        border: none; /* Remove black border from the block */
    }
