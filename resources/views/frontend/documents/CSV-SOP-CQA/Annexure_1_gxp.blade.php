...
<body>
    <header class="">
        ...
        <div style="margin: 0; text-align: center; font-weight: bold;">ANNEXURE - I</div>
        <div style="margin: 0; text-align: center; font-weight: bold;">GxP ASSESSMENT</div>
    ...
    <footer class="footer" style=" font-family: Arial, sans-serif; font-size: 14px; ">
        ...
        <div style="margin: 5px; text-align: left;"><span class="bold">Format No.:</span> CQA/011/F1-00</div>
    ...
    <table style="margin: 5px; margin-bottom: 320px; width: 100%; border-collapse: collapse; border: 1px solid black;">
        ...
        <tbody>
            <tr>
                ...
                <td style="border: 1px solid black; text-align: left;">General information of the system</td>
                <td style="border: 1px solid black; text-align: center;"></td>
            </tr>
            <tr>
                <td style="border: 1px solid black; text-align: center;">2.0</td>
                <td style="border: 1px solid black; text-align: left;">Regulatory compliance - detail assessment</td>
                <td style="border: 1px solid black; text-align: center;"></td>
            </tr>
            <tr>
                <td style="border: 1px solid black; text-align: center;">3.0</td>
                <td style="border: 1px solid black; text-align: left;">GxP assessment for processes / functions</td>
                <td style="border: 1px solid black; text-align: center;"></td>
            </tr>
            <tr>
                <td style="border: 1px solid black; text-align: center;">4.0</td>
                <td style="border: 1px solid black; text-align: left;">Summary of GxP assessment</td>
                <td style="border: 1px solid black; text-align: center;"></td>
            </tr>
            <tr>
                <td style="border: 1px solid black; text-align: center;">5.0</td>
                <td style="border: 1px solid black; text-align: left;">Regulatory compliance scope determination conclusion note</td>
                <td style="border: 1px solid black; text-align: center;"></td>
            </tr>
            <tr>
        ...
        <table>
            <thead>
                <tr>
                    {{-- <th class="w-5">1.0</th> --}}
                    <th class="text-left">
                        <div class="bold">1.0 GENERAL INFORMATION OF THE SYSTEM</div>
                    </th>
                </tr>
            </thead>
        </table>
                    ...
                    <div class="custom-procedure-content">
                        <div class="custom-content-wrapper">
                            @if ($data->document_content)
                                {!! strip_tags($data->document_content->General_information_gxp,
        ...
        <table>
            <thead>
                <tr>
                    {{-- <th class="w-5">2.0</th> --}}
                    <th class="text-left">
                        <div class="bold">2.0 REGULATORY COMPLIANCE — DETAIL ASSESSMENT</div>
                    </th>
                </tr>
            </thead>
        </table>
            ...
            <div class="custom-container">
                <div class="custom-table-wrapper" id="custom-table2">
                    <div class="custom-procedure-content">
                        <div class="custom-content-wrapper">
                            @if ($data->document_content)
                                {!! strip_tags($data->document_content->Regulatory_compliance_gxp,
                                '<br><table><th><td><tbody><tr><p><img><a><span><h1><h2><h3><h4><h5><h6><div><b><ol><li>') !!}
                            @endif
                        </div>
                    </div>
        ...
        <table>
            <thead>
                <tr>
                    {{-- <th class="w-5">3.0</th> --}}
                    <th class="text-left">
                        <div class="bold">3.0 GxP ASSESSMENT FOR PROCESSES / FUNCTIONS</div>
                    </th>
                </tr>
            </thead>
        </table>
            ...
            <div class="custom-container">
                <div class="custom-table-wrapper" id="custom-table2">
                    <div class="custom-procedure-content">
                        <div class="custom-content-wrapper">
                            @if ($data->document_content)
                                {!! strip_tags($data->document_content->GxP_Assessment_For_Processes,
                                '<br><table><th><td><tbody><tr><p><img><a><span><h1><h2><h3><h4><h5><h6><div><b><ol><li>') !!}
                            @endif
                        </div>
                    </div>
        ...
        <table>
            <thead>
                <tr>
                    {{-- <th class="w-5">4.0</th> --}}
                    <th class="text-left">
                        <div class="bold">4.0 SUMMARY OF GxP ASSESSMENT</div>
                    </th>
                </tr>
            </thead>
        </table>
            ...
            <div class="custom-container">
                <div class="custom-table-wrapper" id="custom-table2">
                    <div class="custom-procedure-content">
                        <div class="custom-content-wrapper">
                            @if ($data->document_content)
                                {!! strip_tags($data->document_content->Summary_Of_GxP_Assessment,
                                '<br><table><th><td><tbody><tr><p><img><a><span><h1><h2><h3><h4><h5><h6><div><b><ol><li>') !!}
                            @endif
                        </div>
                    </div>
        ...
        <table>
            <thead>
                <tr>
                    {{-- <th class="w-5">5.0</th> --}}
                    <th class="text-left">
                        <div class="bold">5.0 REGULATORY COMPLIANCE SCOPE DETERMINATION CONCLUSION NOTE</div>
                    </th>
                </tr>
            </thead>
        </table>
            ...
            <div class="custom-container">
                <div class="custom-table-wrapper" id="custom-table2">
                    <div class="custom-procedure-content">
                        <div class="custom-content-wrapper">
                            @if ($data->document_content)
                                {!! strip_tags($data->document_content->Regulatory_Compliance_Scope_gxp,
                                '<br><table><th><td><tbody><tr><p><img><a><span><h1><h2><h3><h4><h5><h6><div><b><ol><li>') !!}
                            @endif
                        </div>
                    </div>
        ...
        <table>
            <thead>
                <tr>
                    {{-- <th class="w-5">6.0</th> --}}
                    <th class="text-left">
                        <div class="bold">6.0 STAKEHOLDER LIST</div>
                    </th>
                </tr>
            </thead>
        </table>
            ...
            <div class="custom-container">
                <div class="custom-table-wrapper" id="custom-table2">
                    <div class="custom-procedure-content">
                        <div class="custom-content-wrapper">
                            @if ($data->document_content)
                                {!! strip_tags($data->document_content->Stakeholder_List_gxp,
                                '<br><table><th><td><tbody><tr><p><img><a><span><h1><h2><h3><h4><h5><h6><div><b><ol><li>') !!}
                            @endif
                        </div>
                    </div>
        ...
        <table>
            <thead>
                <tr>
                    {{-- <th class="w-5">7.0</th> --}}
                    <th class="text-left">
                        <div class="bold">7.0 REFERENCES AND RELATED DOCUMENTS</div>
                    </th>
                </tr>
            </thead>
        </table>
            ...
            <div class="custom-container">
                <div class="custom-table-wrapper" id="custom-table2">
                    <div class="custom-procedure-content">
                        <div class="custom-content-wrapper">
                            @if ($data->document_content)
                                {!! strip_tags($data->document_content->References_and_related_documents_gxp,
                                '<br><table><th><td><tbody><tr><p><img><a><span><h1><h2><h3><h4><h5><h6><div><b><ol><li>') !!}
                            @endif
                        </div>
                    </div>
        ...
        <table>
            <thead>
                <tr>
                    {{-- <th class="w-5">8.0</th> --}}
                    <th class="text-left">
                        <div class="bold">8.0 GLOSSARY OF TERMS</div>
                    </th>
                </tr>
            </thead>
        </table>
            ...
            <div class="custom-container">
                <div class="custom-table-wrapper" id="custom-table2">
                    <div class="custom-procedure-content">
                        <div class="custom-content-wrapper">
                            @if ($data->document_content)
                                {!! strip_tags($data->document_content->Glossary_Of_Terms_gxp,
                                '<br><table><th><td><tbody><tr><p><img><a><span><h1><h2><h3><h4><h5><h6><div><b><ol><li>') !!}
                            @endif
                        </div>
                    </div>
