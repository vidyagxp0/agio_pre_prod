...
<body>
    ...
    <table class="border" border="1">
        <tbody >
            <tr>
                <td class="custom-style" style="width: 30%;" >Name Of Equipment</td>
                <td style="width: 70%;"></td>
            </tr>
            <tr >
                <td class="custom-style"> Equipment ID No.</td>
                <td></td>
            </tr>
            <tr>
                <td class="custom-style">Document No.</td>
                <td></td>
            </tr>
            <tr>
                <td class="custom-style">Date of execution</td>
                <td></td>
            </tr>
        </tbody>
    </table>
    ...
    <div>
        <h2 class="text-center" style="font-weight: bold; font-size:30px">Certification</h2>
    </div>
    ...
    <table  class="table table-bordered" border="1">
        <thead>
            <tr>
                <th class="text-left w-25">REVIEWED BY</th>
                <th>DESIGNATION</th>
                <th>DEPARTMENT</th>
                <th>SIGNATURE</th>
                <th>DATE</th>
    ...
    <footer class="footer" style=" font-family: Arial, sans-serif; font-size: 14px; ">
        ...
        <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">
            ...
            <span>Format No. QA/067/F6-00</span>
    </footer>
