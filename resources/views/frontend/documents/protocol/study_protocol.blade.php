...
<body>
    ...
    <footer class="footer" style=" font-family: Arial, sans-serif; font-size: 14px; ">
        ...
        <span>Format No. QA/004/F19-00                                                                                        </span>
    </footer>
    ...
    <div>
        <section class="main-section" id="pdf-page">
            ...
            <div class="protocol-number" style="text-align: center; font-weight: bold;">
       <h2>PROTOCOL NUMBER ____________</h2> 
    </div>

    <h2 style="text-align: center;">Protocol Approval</h2>
                    ...
                    <table class="table table-bordered" id="distribution-list">
                        ...
                        <tbody style="">
                            ...
                            <tr>
                                ...
                                <td style="font-weight: bold; text-align:left">DEFINATION</td>
                                <td style="font-weight: bold;"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="font-weight: bold; text-align:left">BACKGROUND / HISTORY (IF ANY)</td>
                                <td style="font-weight: bold;"></td>
                            </tr>                        
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="font-weight: bold; text-align:left">ANNEXURES</td>
                                <td style="font-weight: bold;"></td>
                            </tr>

                            <tr>
                                <td style="font-size: 16px; font-weight: bold;">12</td>
                                <td style="font-weight: bold; text-align:left">REFERENCE DOCUMENT NUMBER (IF ANY)</td>
                                <td style="font-weight: bold;"></td>
                            </tr>
                    ...
                    <table class="mb-15">
                        <tbody>
                            <tr>
                                ...
                                <th class="w-95 text-left">
                                    <div class="bold">BACKGROUND / HISTORY (IF ANY) :</div>
                                </th>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="mb-15">
                        <tbody>
                            <tr>
                                ...
                                <th class="w-95 text-left">
                                    <div class="bold">STRATEGY METHEDOLOGY :</div>
                                </th>
                            </tr>
                            <tr>
                        </tbody>
