...
<body>
    ...
    <header class="">
        ...
        <table class="border border-top-none" border="1"
            ...
            <tbody>
                <tr>
                    <td style="width: 35%; padding: 5px; text-align: left" class="doc-num">Title</td>
                    <td style="width: 65%; padding: 5px; text-align: left">
                      REVALIDATION PROTOCOL FOR MEDIA FILLL
                    </td>
        ...
        <table class="border border-top-none" border="1"
            ...
            <tbody>
                ...
                <tr style="height:10px">
                    ...
                    <td style="width: 30%; padding: 5px; text-align: left" class="doc-num">Superseded Number:</td>
    ...
    <div class="text-center" >
        <h2 style="font-weight: bold;" >PROTOCOL OF </h2>
        <h2 style="font-weight: bold;">MEDIA FILL VALIDATION</h2>
    </div>
