...
@section('container')
        ...
        <div class="container-fluid">
            <div class="dashboard-container">
                ...
                <div class="cctab">
                    ...
                    @if (Helpers::checkRoles(6))
                        <button class="cctablinks active" onclick="openCity(event, 'CCForm3')"><i class="fas fa-user"></i>
                            Employee</button>
                        <button class="cctablinks " onclick="openCity(event, 'CCForm6')"><i
                                class="fas fa-chalkboard-teacher"></i> Induction Training</button>
                        <button class="cctablinks " onclick="openCity(event, 'CCForm5')"><i class="fas fa-briefcase"></i> On
                            The Job Training</button>

                        <button class="cctablinks " onclick="openCity(event, 'CCForm7')"><i class="fas fa-file-alt"></i> Job
                            Description</button>

                        <button class="cctablinks " onclick="openCity(event, 'CCForm4')"><i
                                class="fas fa-graduation-cap"></i> Trainer Qualification</button>

                        <button class="cctablinks " onclick="openCity(event, 'CCForm1')"><i class="fas fa-book"></i> My
                            Training</button>
                    @endif
                    @if (Helpers::checkRoles(1) ||
                        ...
                        <button class="cctablinks" onclick="openCity(event, 'CCForm2')"><i
                                class="fa-solid fa-user-check"></i> Assigned To Me</button>
                    @endif
                </div>
 ...
 <script>
                    ...
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        if (savedTab) {
                            var button = document.querySelector(`[onclick*="${savedTab}"]`);
                            if (button) {
                                button.click();
                            }
                        } else {

                            document.querySelector(".cctablinks").click();
                        }
                    });
                </script>
                {{-- ================CC Form1================ --}}
    ...
    @php
        $trainingStatusCheck = DB::table('training_statuses')
            ...
            ->first();
        $trainingPlanName = DB::table('trainings')->where('id', $temp->traningstatus->training_plan)->first();
        $traininerName = DB::table('users')->where('id', $trainingPlanName->trainner_id)->first();
    @endphp
                                    <tr>
                        ...
                        <tbody>
                            ...
                            @foreach ($jobTrainings as $index => $job_training)
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="view-report-btn"
                                            onclick="window.location.href='{{ url('rcms/job_training_report/' . $job_training->id) }}'">
                                            <i class="fa fa-file-alt"></i>
                                        </button>
                </div>
                </td>
                                ...
                                @foreach ($inductionTraining as $index => $induction)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="view-report-btn"
                                                onclick="window.location.href='{{ url('rcms/induction_report/' . $induction->id) }}'">
                                                <i class="fa fa-file-alt"></i>
                                            </button>
                </div>
                </td>
