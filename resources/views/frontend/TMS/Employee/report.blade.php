            ...
            <div class="block">
                ...
                <table>
                       <tr>
                            ...
                            <td class="w-80">@if($data->site_division){{ $data->site_division }}@else Not Applicable @endif</td>

                            <th class="w-20">Joining Date:</th>
                            <td class="w-80">@if($data->joining_date){{ $data->joining_date}}@else Not Applicable @endif</td>
                     </tr>
