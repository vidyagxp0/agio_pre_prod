                     ...
                     <div class="d-flex justify-content-between align-items-center">
                         ...
                         <div class="buttons-new">
                             ...
                             <button class="button_theme1"><a class="text-white"
                                     href="{{ url('errata/show/' . $document->id) }}">
                                     Back
                                 </a>
                             </button>
                             ...
                             <div class="modal-content">
                                 ...
                                 @php
                                     $reviewer = DB::table('audit_reviewers_details')
                                         ->where(['doc_id' => $document->id, 'type' => 'ERRATA'])
                                         ->get();
                                 @endphp
                                 <!-- Customer grid view -->
                             ...
                             <div class="modal-content">
                                 ...
                                 <form action="{{ route('store_audit_review', $document->id) }}" method="POST">
                                     ...
                                     <div class="modal-body">
                                         ...
                                         <input type="hidden" id="type" name="type" value="ERRATA">
                                     </div>
         ...
         <div class="inner-block">
             ...
             <div class="second-table">
                 <table>
                     ...
                     <tbody id="audit-data">
                         @include('frontend.errata.errata_filter')
                     </tbody>
                 </table>
             </div>
         </div>
     ...
     <script type='text/javascript'>
         $(document).ready(function() {
             function fetchDataAudit() {
                 ...
                 $.ajax({
                     url: "{{ route('api.ERRATA.filter', $document->id) }}",
                     method: "GET",
                     data: {
                         typedata: typedata,
                         user: user,
