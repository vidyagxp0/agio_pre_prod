                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <input disabled type="text" name="record_number"
                                                    value="{{ Helpers::getDivisionName($data->division_id) }}/Extension/{{ Helpers::year($data->created_at) }}/{{ $data->record_number ? str_pad($data->record_number->record_number, 4, "0", STR_PAD_LEFT ) : '1' }}">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="group-input">
                                                ...
                                                <select name="initiated_through" {{ $data->stage == 0 || $data->stage == 3 ? "disabled" : "" }} {{$data->initiated_through}}
                                                    ...
                                                    <option @if ($data->initiated_through == 'Effectiveness Check') selected @endif value="Effectiveness Check">Effectivness Check</option>
                                                </select>
                                            </div>
                                    </div>
                                    <div class="col-lg-6">
