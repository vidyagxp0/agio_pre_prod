                                        ...
                                        <div class="col-lg-12">
                                            <div class="group-input">
                                                ...
                                                @php
                                                    ...
                                                    $selectedDepartments = explode(',', $storedDepartments); // Split the comma-separated string into an array
                                                @endphp
                                                ...
                                                <select multiple name="departments[]" placeholder="Select Department(s)"
                                                    ...
                                                    <option value="Corporate Quality Assurance"
                                                        @if (in_array('Corporate Quality Assurance', $selectedDepartments)) selected @endif>
                                                        Corporate Quality Assurance
                                                    </option>
                                                    <option value="Quality Assurance"
                                                        @if (in_array('Quality Assurance', $selectedDepartments)) selected @endif>
                                                        Quality Assurance
                                                    </option>
                                                    <option value="Quality Control"
                                                        @if (in_array('Quality Control', $selectedDepartments)) selected @endif>
                                                        Quality Control
                                                    </option>
                                                    <option value="Quality Control (Microbiology department)"
                                                        @if (in_array('Quality Control (Microbiology department)', $selectedDepartments)) selected @endif>
                                                        Quality Control (Microbiology department)
                                                    </option>
                                                    <option value="Production General"
                                                        @if (in_array('Production General', $selectedDepartments)) selected @endif>
                                                        Production General
                                                    </option>
                                                    <option value="Production Liquid Orals"
                                                        @if (in_array('Production Liquid Orals', $selectedDepartments)) selected @endif>
                                                        Production Liquid Orals
                                                    </option>
                                                    <option value="Production Tablet and Powder"
                                                        @if (in_array('Production Tablet and Powder', $selectedDepartments)) selected @endif>
                                                        Production Tablet and Powder
                                                    </option>
                                                    <option value="Production External (Ointment, Gels, Creams and Liquid)"
                                                        @if (in_array('Production External (Ointment, Gels, Creams and Liquid)', $selectedDepartments)) selected @endif>
                                                        Production External (Ointment, Gels, Creams and Liquid)
                                                    </option>
                                                    <option value="Production Capsules"
                                                        @if (in_array('Production Capsules', $selectedDepartments)) selected @endif>
                                                        Production Capsules
                                                    </option>
                                                    <option value="Production Injectable"
                                                        @if (in_array('Production Injectable', $selectedDepartments)) selected @endif>
                                                        Production Injectable
                                                    </option>
                                                    <option value="Engineering"
                                                        @if (in_array('Engineering', $selectedDepartments)) selected @endif>
                                                        Engineering
                                                    </option>
                                                    <option value="Human Resource"
                                                        @if (in_array('Human Resource', $selectedDepartments)) selected @endif>
                                                        Human Resource
                                                    </option>
                                                    <option value="Store"
                                                        @if (in_array('Store', $selectedDepartments)) selected @endif>
                                                        Store
                                                    </option>
                                                    <option value="Electronic Data Processing"
                                                        @if (in_array('Electronic Data Processing', $selectedDepartments)) selected @endif>
                                                        Electronic Data Processing
                                                    </option>
                                                    <option value="Formulation Development"
                                                        @if (in_array('Formulation Development', $selectedDepartments)) selected @endif>
                                                        Formulation Development
                                                    </option>
                                                    <option value="Analytical research and Development Laboratory"
                                                        @if (in_array('Analytical research and Development Laboratory', $selectedDepartments)) selected @endif>
                                                        Analytical research and Development Laboratory
                                                    </option>
                                                    <option value="Packaging Development"
                                                        @if (in_array('Packaging Development', $selectedDepartments)) selected @endif>
                                                        Packaging Development
                                                    </option>
                                                    <option value="Purchase Department"
                                                        @if (in_array('Purchase Department', $selectedDepartments)) selected @endif>
                                                        Purchase Department
                                                    </option>
                                                    <option value="Document Cell"
                                                        @if (in_array('Document Cell', $selectedDepartments)) selected @endif>
                                                        Document Cell
                                                    </option>
                                                    <option value="Regulatory Affairs"
                                                        @if (in_array('Regulatory Affairs', $selectedDepartments)) selected @endif>
                                                        Regulatory Affairs
                                                    </option>
                                                    <option value="Pharmacovigilance"
                                                        @if (in_array('Pharmacovigilance', $selectedDepartments)) selected @endif>
                                                        Pharmacovigilance
                                                    </option>
                                                </select>
                                            </div>
                            ...
                            <input name="related_url" {{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }} value="{{ $data->related_url }}">
                                    ...
                                    <div class="button-block">
                                        <button type="submit" id="ChangesaveButton"
                                            class="saveButton"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>Save</button>
                        ...
                        <div id="CCForm5" class="inner-block cctabcontent">
                            <div class="inner-block-content">
                                <div class="row">
                                    ...
                                    @php
                                        // Get the investigation team IDs from the stored data
                                        $investigationTeamIds = explode(',', $data->investigation_team ?? '');

                                        // Fetch the users from the database based on the stored IDs
                                        $investigationTeamMembers = App\Models\User::whereIn(
                                            'id',
                                            $investigationTeamIds,
                                        )->get();
                                    @endphp
                                    <div class="col-lg-12">
                                        <div class="group-input">
                                            ...
                                            <select id="investigation_team" name="investigation_team[]" multiple
                                                ...
                                                @foreach ($users as $user)
                                                    <option value="{{ $user->name }}" {{-- Check if the user is part of the selected investigation team --}}
                                                        {{ in_array($user->name, explode(',', $data->investigation_team ?? '')) ? 'selected' : '' }}>
                                                        {{ $user->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="why-row">
                                                            <th style="width:150px; color: #393cd4;">
                                                                Why 1 <span
                                                                    onclick="addWhyField('why_1_block', 'why_1[]')"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>+</span>
                                                            </th>
                                                            <td>
                                                                <div
                                                                    class="why_1_block"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>
                                                                    @if (!empty($data->why_1))
                                                                        @foreach (unserialize($data->why_1) as $key => $measure)
                                                                            <textarea name="why_1[]"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>{{ $measure }}</textarea>
                                                                        @endforeach
                                                                    @endif
                                                        ...
                                                        <tr class="why-row">
                                                            <th style="width:150px; color: #393cd4;">
                                                                Why 2 <span
                                                                    onclick="addWhyField('why_2_block', 'why_2[]')"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>+</span>
                                                            </th>
                                                            <td>
                                                                <div class="why_2_block">
                                                                    @if (!empty($data->why_2))
                                                                        @foreach (unserialize($data->why_2) as $key => $measure)
                                                                            <textarea name="why_2[]"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>{{ $measure }}</textarea>
                                                                        @endforeach
                                                                    @endif
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr class="why-row">
                                                            <th style="width:150px; color: #393cd4;">
                                                                Why 3 <span
                                                                    onclick="addWhyField('why_3_block', 'why_3[]')"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>+</span>
                                                            </th>
                                                            <td>
                                                                <div class="why_3_block">
                                                                    @if (!empty($data->why_3))
                                                                        @foreach (unserialize($data->why_3) as $key => $measure)
                                                                            <textarea name="why_3[]"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>{{ $measure }}</textarea>
                                                                        @endforeach
                                                                    @endif
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr class="why-row">
                                                            <th style="width:150px; color: #393cd4;">
                                                                Why 4 <span
                                                                    onclick="addWhyField('why_4_block', 'why_4[]')"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>+</span>
                                                            </th>
                                                            <td>
                                                                <div class="why_4_block">
                                                                    @if (!empty($data->why_4))
                                                                        @foreach (unserialize($data->why_4) as $key => $measure)
                                                                            <textarea name="why_4[]"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>{{ $measure }}</textarea>
                                                                        @endforeach
                                                                    @endif
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr class="why-row">
                                                            <th style="width:150px; color: #393cd4;">
                                                                Why 5 <span
                                                                    onclick="addWhyField('why_5_block', 'why_5[]')"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>+</span>
                                                            </th>
                                                            <td>
                                                                <div class="why_5_block">
                                                                    @if (!empty($data->why_5))
                                                                        @foreach (unserialize($data->why_5) as $key => $measure)
                                                                            <textarea name="why_5[]"{{ $data->stage == 0 || $data->stage == 8 ? 'disabled' : '' }}>{{ $measure }}</textarea>
                                                                        @endforeach
                                                                    @endif
                                                                </div>
                                                            </td>
