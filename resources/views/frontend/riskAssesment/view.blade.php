                ...
                <div id="CCForm8" class="inner-block cctabcontent">
                    <div class="inner-block-content">
                        <div class="row">
                            ...
                            <div class="sub-head"> Production Injection </div>
                            <script>
                                $(document).ready(function() {
                            ...
                            @if ($data->stage == 2 || $data->stage == 3)
                                ...
                                <div class="col-lg-6 productionInjection">
                                    <div class="group-input">
                                        <label for="Warehouse Person">Production Injection Person <span
                                                id="asteriskware"
                                ...
                                <div class="col-md-12 mb-3 productionInjection">
                                    <div class="group-input">
                                        <label for="Warehouse Feedback">Production Injection Feedback<span
                                                id="asteriskware3"
                                                style="display: {{ $data1->Warehouse_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <div><small class="text-primary">Please insert "NA" in the data field if it
                            ...
                            @else
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        <label for="Warehouse Review Required">Production Injection Review Required
                                            ?</label>
                                        <select disabled name="Production_Injection_Review"
                                            id="Production_Injection_Review">
                                            <option value="">-- Select --</option>
                                            <option @if ($data1->Production_Injection_Review == 'yes') selected @endif value="yes">Yes
                                            </option>
                                            <option @if ($data1->Production_Injection_Review == 'no') selected @endif value="no">No
                                            </option>
                                            <option @if ($data1->Production_Injection_Review == 'na') selected @endif value="na">NA
                                            </option>
                                ...
                                @if ($data->stage == 3)
                                    <div class="col-md-12 mb-3 productionInjection">
                                        <div class="group-input">
                                            <label for="Impact Assessment1">Impact Assessment (By Production Injection
                                                Assessment)</label>
                                            <div><small class="text-primary">Please insert "NA" in the data field if
                        ...
                        <input disabled
                            ...
                            @if ($data->stage == 2 || $data->stage == 3)
                                ...
                                <div class="col-md-12 mb-3 human_resources">
                                    <div class="group-input">
                                        <label for="productionfeedback">Impact Assessment (By Human Resource on ) <span
                                                id="asteriskHR1"
                            ...
                            @if ($data->stage == 2 || $data->stage == 3)
                                ...
                                <div class="col-lg-6 store">
                                    <div class="group-input">
                                        ...
                                        <select @if ($data->stage == 3) disabled @endif name="Store_person"
