                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <select name="Production_Review" id="Production_Review"
                                                ...
                                                <option value=""> Select</option>
                                                <option @if (isset($data1) && $data1->Production_Review == 'yes') selected @endif
                                                    value='yes'>
                                                    Yes</option>
                                                <option @if (isset($data1) && $data1->Production_Review == 'no') selected @endif
                                                    value='no'>
                                                    No</option>
                                                <option @if (isset($data1) && $data1->Production_Review == 'na') selected @endif
                                                    value='na'>
                                                    NA</option>
                                            </select>
                                    ...
                                    <div class="col-md-12 mb-3 p_erson">
                                        <div class="group-input">
                                            ...
                                            {{-- <textarea @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif class="summernote Production_assessment"
                                                ...
                                                <textarea
                                                    @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                                    class="summernote Production_assessment"
                                                    @if ($data->stage == 4 || (isset($data1) && $data1->Production_person)) readonly @endif    name="Production_assessment"
                                                        id="summernote-17">{{ isset($data1) ? $data1->Production_assessment : '' }}
                                                    </textarea>
                                    ...
                                    <div class="col-md-12 mb-3 p_erson">
                                        <div class="group-input">
                                            ...
                                            {{-- <textarea class="summernote Production_feedback" @if ($data->stage == 3 || Auth::user()->id != isset($data1) && $data1->Production_person) readonly @endif
                                                ...
                                                @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                                class="summernote Production_assessment"
                                                @if ($data->stage == 4 || (isset($data1) && $data1->Production_person)) readonly @endif
                                                name="Production_assessment"
                                                id="summernote-17"
                                            >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                    ...
                                    <div class="col-md-6 mb-3 p_erson">
                                        <div class="group-input">
                                            <label for="Production Review Completed By">Production Review Completed
                                                By</label>
                                            <input readonly type="text" value="{{ isset($data1) && $data1->Production_by }}"
                                ...
                                @else
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <select name="Production_Review" disabled id="Production_Review">
                                                <option value=""> Select </option>
                                                <option @if ( isset($data1) && $data1->Production_Review == 'yes') selected @endif value='yes'>Yes</option>
                                                <option @if ( isset($data1) && $data1->Production_Review == 'no') selected @endif value='no'>No</option>
                                                <option @if ( isset($data1) && $data1->Production_Review == 'na') selected @endif value='na'>NA</option>
                                            </select>
                                    ...
                                    <div class="col-md-6 mb-3 p_erson">
                                        <div class="group-input">
                                            <label for="Production Review Completed By">Production Review Completed
                                                By</label>
                                            <input readonly type="text" value="{{ isset($data1) && isset($data1) && $data1->Production_by }}"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <select @if ($data->stage == 3) required @endif
                                                ...
                                                <option value="0">Select </option>
                                                <option @if (isset($data1) && $data1->Warehouse_review == 'yes') selected @endif
                                                    value="yes">Yes</option>
                                                <option @if (isset($data1) && $data1->Warehouse_review == 'no') selected @endif
                                                    value="no">No</option>
                                                <option @if (isset($data1) && $data1->Warehouse_review == 'na') selected @endif
                                                    value="na">NA</option>
                                    ...
                                    <div class="col-md-12 mb-3 warehouse">
                                        <div class="group-input">
                                            ...
                                            {{-- <textarea @if (isset($data1) && $data1->Warehouse_review == 'yes' && $data->stage == 4) required @endif class="summernote Warehouse_assessment"
                                                ...
                                                @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                                class="summernote Production_assessment"
                                                @if ($data->stage == 4 || (isset($data1) && $data1->Warehouse_notification)) readonly @endif
                                                name="Production_assessment"
                                                id="summernote-17"
                                            >{{ isset($data1) ? $data1->Warehouse_notification : '' }}</textarea>
                                    ...
                                    <div class="col-md-12 mb-3 warehouse">
                                        <div class="group-input">
                                            ...
                                            {{-- <textarea @if (isset($data1) && $data1->Warehouse_review == 'yes' && $data->stage == 4) required @endif class="summernote Warehouse_feedback"
                                                ...
                                                @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                                class="summernote Production_assessment"
                                                @if ($data->stage == 4 || (isset($data1) && $data1->Warehouse_feedback)) readonly @endif
                                                name="Production_assessment"
                                                id="summernote-17"
                                            >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                    ...
                                    <div class="col-md-6 mb-3 warehouse">
                                        <div class="group-input">
                                            <label for="Warehouse Review Completed By">Warehouse Review Completed
                                                By</label>
                                            <input disabled type="text" value="{{ isset($data1) && $data1->Warehouse_by }}"
                                    ...
                                    <div class="col-lg-6 warehouse">
                                        <div class="group-input">
                                            ...
                                            <select disabled name="Warehouse_review" id="Warehouse_review">
                                                <option value="0">-- Select --</option>
                                                <option @if (isset($data1) && isset($data1) && $data1->Warehouse_review == 'yes') selected @endif
                                                    value="yes">Yes</option>
                                                <option @if (isset($data1) && isset($data1) && $data1->Warehouse_review == 'no') selected @endif
                                                    value="no">No</option>
                                                <option @if ( isset ($data1) && isset($data1) && $data1->Warehouse_review == 'na') selected @endif
                                                    value="na">NA</option>
                        ...
                        @else
                            ...
                            <div class="col-md-6 mb-3 warehouse">
                                <div class="group-input">
                                    ...
                                    <input disabled type="text" value="{{isset($data1) && isset($data1) && $data1->Warehouse_by }}"
                                        name="Warehouse_by" id="Warehouse_by">
                                </div>
                            </div>
                            <div class="col-lg-6 warehouse">
                            ...
                            @if ($data->stage == 3 || $data->stage == 4)
                                ...
                                <div class="col-md-12 mb-3 quality_control">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Quality_review == 'yes' && $data->stage == 4) required @endif class="summernote Quality_Control_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Quality_Control_Person)) readonly @endif
                                            name="Production_assessment"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-6 mb-3 quality_control">
                                    <div class="group-input">
                                        <label for="Quality Control Review Completed By">Quality Control Review Completed
                                            By</label>
                                        <input disabled type="text" value="{{ isset($data1) && $data1->Quality_Control_by }}"
                                ...
                                <div class="col-md-12 mb-3 quality_assurance">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Quality_Assurance_Review == 'yes' && $data->stage == 4) required @endif class="summernote QualityAssurance_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->QualityAssurance_person)) readonly @endif
                                            name="QualityAssurance_person"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-12 mb-3 quality_assurance">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Quality_Assurance_Review == 'yes' && $data->stage == 4) required @endif class="summernote QualityAssurance_feedback"
                                            ...
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->QualityAssurance_person)) readonly @endif
                                            name="QualityAssurance_feedback"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-lg-6 engineering">
                                    <div class="group-input">
                                        ...
                                        <select name="Engineering_person" class="Engineering_person"
                                            ...
                                            <option value="">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && $data1->Engineering_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-12 mb-3 engineering">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Engineering_review == 'yes' && $data->stage == 4) required @endif class="summernote Engineering_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Engineering_person)) readonly @endif
                                ...
                                <div class="col-md-6 mb-3 engineering">
                                    <div class="group-input">
                                        <label for="Engineering Review Completed By">Engineering Review Completed
                                            By</label>
                                        <input disabled type="text" value="{{ isset($data1) && $data1->Engineering_by }}"
                                ...
                                <div class="col-md-12 mb-3 analytical_development">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Analytical_Development_review == 'yes' && $data->stage == 4) required @endif class="summernote Analytical_Development_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Analytical_Development_person)) readonly @endif
                                            name="Analytical_Development_assessment"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-12 mb-3 analytical_development">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Analytical_Development_review == 'yes' && $data->stage == 4) required @endif class="summernote Analytical_Development_feedback"
                                            ...
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Analytical_Development_person)) readonly @endif
                                            name="Analytical_Development_feedback"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-6 mb-3  analytical_development">
                                    <div class="group-input">
                                        ...
                                        <input disabled type="text" value="{{ isset($data1) && $data1->Analytical_Development_by }}"
                                ...
                                <div class="col-lg-6 kilo_lab">
                                    <div class="group-input">
                                        ...
                                        <select name="Kilo_Lab_person" class="Kilo_Lab_person" id="Kilo_Lab_person"
                                            ...
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && $data1->Kilo_Lab_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Kilo_Lab_review == 'yes' && $data->stage == 4) required @endif class="summernote Analytical_Development_assessment"
                                            ...
                                            <textarea
                                                @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                                class="summernote Production_assessment"
                                                @if ($data->stage == 4 || (isset($data1) && $data1->Kilo_Lab_person)) readonly @endif
                                                name="Kilo_Lab_assessment"
                                                id="summernote-17"
                                            >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-6 mb-3 kilo_lab">
                                    <div class="group-input">
                                        ...
                                        <input disabled type="text" value="{{ isset($data1) && $data1->Kilo_Lab_attachment_by }}"
                                ...
                                <div class="col-md-12 mb-3 technology_transfer">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Technology_transfer_review == 'yes' && $data->stage == 4) required @endif class="summernote Technology_transfer_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Technology_transfer_assessment)) readonly @endif
                                            name="Technology_transfer_assessment"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                    ...
                                    <div class="group-input">
                                        <label for="Design Feedback"> Technology Transfer / Design Feedback <span
                                            ...
                                            {{-- <textarea @if (isset($data1) && $data1->Technology_transfer_review == 'yes' && $data->stage == 4) required @endif class="summernote Technology_transfer_feedback"
                                                ...
                                                @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                                class="summernote Production_assessment"
                                                @if ($data->stage == 4 || (isset($data1) && $data1->Technology_transfer_feedback)) readonly @endif
                                                name="Technology_transfer_feedback"
                                                id="summernote-17"
                                            >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-6 mb-3 technology_transfer">
                                    <div class="group-input">
                                        <label for="productionfeedback">Technology Transfer / Design Review Completed
                                            By</label>
                                        <input disabled type="text" value="{{ isset($data1) && $data1->Technology_transfer_by }}"
                                ...
                                <div class="col-md-12 mb-3 environmental_health">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Environment_Health_review == 'yes' && $data->stage == 4) required @endif class="tiny" name="Health_Safety_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Health_Safety_assessment)) readonly @endif
                                            name="Health_Safety_assessment"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-12 mb-3 environmental_health">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Environment_Health_review == 'yes' && $data->stage == 4) required @endif class="tiny" name="Health_Safety_feedback"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Health_Safety_feedback)) readonly @endif
                                            name="Health_Safety_feedback"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-lg-6 human_resources">
                                    <div class="group-input">
                                        ...
                                        <select name="Human_Resource_person" class="Human_Resource_person"
                                            ...
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && $data1->Human_Resource_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12 mb-3 human_resources">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Human_Resource_review == 'yes' && $data->stage == 4) required @endif class="summernote Human_Resource_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Human_Resource_person)) readonly @endif
                                            name="Human_Resource_assessment"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-12 mb-3 human_resources">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Human_Resource_review == 'yes' && $data->stage == 4) required @endif class="summernote Human_Resource_feedback"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Human_Resource_feedback)) readonly @endif
                                            name="Human_Resource_feedback"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-6 mb-3 human_resources">
                                    <div class="group-input">
                                        ...
                                        <input disabled type="text" value="{{ isset($data1) && $data1->Human_Resource_by }}"
                                ...
                                <div class="col-md-12 mb-3 information_technology">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Information_Technology_review == 'yes' && $data->stage == 4) required @endif class="summernote Information_Technology_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Information_Technology_person)) readonly @endif
                                            name="Information_Technology_assessment"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-12 mb-3 information_technology">
                                    <div class="group-input">
                                        ...
                                        @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                        class="summernote Production_assessment"
                                        @if ($data->stage == 4 || (isset($data1) && $data1->Information_Technology_feedback)) readonly @endif
                                        name="Information_Technology_feedback"
                                        id="summernote-17"
                                    >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-6 mb-3 information_technology">
                                    <div class="group-input">
                                        <label for="Information Technology Review Completed By"> Information Technology
                                            Review Completed By</label>
                                        <input disabled type="text" value="{{ isset($data1) && $data1->Information_Technology_by }}"
                                ...
                                <div class="col-md-12 mb-3 project_management">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Project_management_review == 'yes' && $data->stage == 4) required @endif class="summernote Project_management_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Project_management_assessment)) readonly @endif
                                            name="Project_management_assessment"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                        </div>
                                </div>
                                <div class="col-md-12 mb-3 project_management">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Project_management_review == 'yes' && $data->stage == 4) required @endif class="summernote Project_management_feedback"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Project_management_feedback)) readonly @endif
                                            name="Project_management_feedback"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-6 mb-3 project_management">
                                    <div class="group-input">
                                        <label for="Project management Review Completed By"> Project management Review
                                            Completed By</label>
                                        <input disabled type="text" value="{{ isset($data1) && $data1->Project_management_by }}"
                            ...
                            @else
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        <label for="Quality Control Review Completed By">Quality Control Review Completed
                                            By</label>
                                        <input disabled type="text" value="{{isset($data1) &&  isset($data1) && $data1->Quality_Control_by }}"
                                            name="Quality_Control_by" id="Quality_Control_by">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        <label for="Quality Assurance Review Completed By">Quality Assurance Review
                                            Completed By</label>
                                        <input disabled type="text" value="{{ isset($data1) && isset($data1) && $data1->QualityAssurance_by }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <input disabled type="date"id="QualityAssurance_on"
                                            name="QualityAssurance_on" value="{{isset($data1) &&  isset($data1) && $data1->QualityAssurance_on }}">
                                    </div>
                                </div>
                                <div class="sub-head">
                                    Engineering
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select disabled name="Engineering_person" id="Engineering_person">
                                            <option value="">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && isset($data1) && $data1->Engineering_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        <label for="Engineering Review Completed By">Engineering Review Completed
                                            By</label>
                                        <input disabled type="text" value="{{ isset($data1) && isset($data1) && $data1->Engineering_by }}"
                                            name="Engineering_by" id="Engineering_by">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        <label for="Analytical Development Laboratory Review Completed By">Analytical
                                            Development Laboratory Review Completed By</label>
                                        <input disabled type="text" value="{{ isset($data1) && isset($data1) && $data1->Analytical_Development_by }}"
                                            name="Analytical_Development_by" id="Analytical_Development_by">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select disabled name="Kilo_Lab_person" id="Kilo_Lab_person">
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{isset($data1) && isset($data1) && $data1->Kilo_Lab_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        <label for="Kilo Lab Review Completed By">Process Development Laboratory / Kilo
                                            Lab Review Completed By</label>
                                        <input disabled type="text" value="{{ isset($data1) &&  isset($data1) && $data1->Kilo_Lab_attachment_by }}"
                                            name="Kilo_Lab_attachment_by" id="Kilo_Lab_attachment_by">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        <label for="productionfeedback">Technology Transfer / Design Review Completed
                                            By</label>
                                        <input disabled type="text" value="{{ isset($data1) && isset($data1) && $data1->Technology_transfer_by }}"
                                            name="Technology_transfer_by" id="Technology_transfer_by">
                                ...
                                <div class="col-lg-6">
                                    <div class="group-input">
                                        ...
                                        <select disabled name="Human_Resource_person" id="Human_Resource_person">
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && isset($data1) && $data1->Human_Resource_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        <label for="Information Technology Review Completed By"> Information Technology
                                            Review Completed By</label>
                                        <input disabled type="text" value="{{isset($data1) && isset($data1) && $data1->Information_Technology_by }}"
                                            name="Information_Technology_by" id="Information_Technology_by">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="group-input">
                                        ...
                                        <input disabled type="date" name="Project_management_on"
                                            id="Project_management_on" value={{ isset($data1) && $data1->Project_management_on }}>
                                ...
                                <div class="col-lg-6 other1_reviews ">
                                    <div class="group-input">
                                        ...
                                        <select name="Other1_person" @if ($data->stage == 4) disabled @endif
                                            ...
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && $data1->Other1_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                ...
                                <div class="col-lg-12 other1_reviews ">
                                    ...
                                    <div class="group-input">
                                        ...
                                        <select name="Other1_Department_person"
                                            ...
                                            <option value="0">-- Select --</option>
                                            <option @if (isset($data1) && $data1->Other1_Department_person == 'Production') selected @endif
                                                value="Production">Production</option>
                                            <option @if (isset($data1) && $data1->Other1_Department_person == 'Warehouse') selected @endif
                                            ...
                                            <option @if (isset($data1) && $data1->Other1_Department_person == 'Engineering') selected @endif
                                ...
                                <div class="col-md-12 mb-3 other1_reviews ">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Other1_review == 'yes' && $data->stage == 4) required @endif class="tiny" name="Other1_assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Other1_assessment)) readonly @endif
                                    ...
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if (isset($data1) && $data1->Other1_review == 'yes' && $data->stage == 4) required @endif class="tiny" name="Other1_feedback"
                                          ...
                                          <textarea
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Other1_feedback)) readonly @endif
                                            name="Other1_feedback"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-lg-6 Other2_reviews">
                                    <div class="group-input">
                                        ...
                                        <select name="Other2_person" @if ($data->stage == 4) disabled @endif
                                            ...
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && $data1->Other2_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-12 Other2_reviews">
                                    <div class="group-input">
                                        ...
                                        <select name="Other2_Department_person"
                                            ...
                                            <option value="0">-- Select --</option>
                                            <option @if (isset($data1) && $data1->Other2_Department_person == 'Production') selected @endif
                                                value="Production">Production</option>
                                            <option @if (isset($data1) && $data1->Other2_Department_person == 'Warehouse') selected @endif
                                                value="Warehouse"> Warehouse</option>
                                            ...
                                            <option @if (isset($data1) && $data1->Other2_Department_person == 'Quality_Assurance') selected @endif
                                                value="Quality_Assurance">Quality Assurance</option>
                                            <option @if (isset($data1) && $data1->Other2_Department_person == 'Engineering') selected @endif
                                                value="Engineering">Engineering</option>
                                ...
                                <div class="col-md-12 mb-3 Other2_reviews">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if ($data->stage == 3 || Auth::user()->id != isset($data1) && $data1->Other2_person) readonly @endif class="tiny" name="Other2_feedback"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Other2_feedback)) readonly @endif
                                            name="Other2_feedback"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-lg-6 Other3_reviews">
                                    <div class="group-input">
                                        ...
                                        <select name="Other3_person" @if ($data->stage == 4) disabled @endif
                                            ...
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && $data1->Other3_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                ...
                                <div class="col-lg-12 Other3_reviews">
                                    <div class="group-input">
                                        ...
                                        <select name="Other3_Department_person"
                                            ...
                                            <option value="0">-- Select --</option>
                                            <option @if (isset($data1) && $data1->Other3_Department_person == 'Production') selected @endif
                                                value="Production">Production</option>
                                            <option @if (isset($data1) && $data1->Other3_Department_person == 'Warehouse') selected @endif
                                                value="Warehouse"> Warehouse</option>
                                            ...
                                            <option @if (isset($data1) && $data1->Other3_Department_person == 'Quality_Assurance') selected @endif
                                                value="Quality_Assurance">Quality Assurance</option>
                                            <option @if (isset($data1) && $data1->Other3_Department_person == 'Engineering') selected @endif
                                                value="Engineering">Engineering</option>
                                ...
                                <div class="col-md-12 mb-3 Other3_reviews">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if ($data->stage == 3 || Auth::user()->id != isset($data1) && $data1->Other3_person) readonly @endif class="tiny" name="Other3_Assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Other3_Assessment)) readonly @endif
                                ...
                                <div class="col-lg-6 Other4_reviews">
                                    <div class="group-input">
                                        ...
                                        <select name="Other4_person" @if ($data->stage == 4) disabled @endif
                                            ...
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && $data1->Other4_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-12 Other4_reviews">
                                    <div class="group-input">
                                        ...
                                        <select name="Other4_Department_person"
                                            ...
                                            <option value="0">-- Select --</option>
                                            <option @if (isset($data1) && $data1->Other4_Department_person == 'Production') selected @endif
                                                value="Production">Production</option>
                                            <option @if (isset($data1) && $data1->Other4_Department_person == 'Warehouse') selected @endif
                                                value="Warehouse"> Warehouse</option>
                                            ...
                                            <option @if (isset($data1) && $data1->Other4_Department_person == 'Quality_Assurance') selected @endif
                                                value="Quality_Assurance">Quality Assurance</option>
                                            <option @if (isset($data1) && $data1->Other4_Department_person == 'Engineering') selected @endif
                                                value="Engineering">Engineering</option>
                                ...
                                <div class="col-md-12 mb-3 Other4_reviews">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if ($data->stage == 3 || Auth::user()->id != isset($data1) && $data1->Other4_person) readonly @endif class="tiny" name="Other4_Assessment"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Other4_Assessment)) readonly @endif
                                            name="Other4_Assessment"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-12 mb-3 Other4_reviews">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if ($data->stage == 3 || Auth::user()->id != isset($data1) && $data1->Other4_person) readonly @endif class="tiny" name="Other4_feedback"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Other4_feedback)) readonly @endif
                                            name="Other4_feedback"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                        </div>
                                </div>
                                ...
                                <div class="col-lg-6 Other5_reviews">
                                    <div class="group-input">
                                        ...
                                        <select name="Other5_person" @if ($data->stage == 4) disabled @endif
                                            ...
                                            <option value="0">-- Select --</option>
                                            @foreach ($users as $user)
                                                <option {{ isset($data1) && $data1->Other5_person == $user->id ? 'selected' : '' }}
                                                    value="{{ $user->id }}">{{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-12 Other5_reviews">
                                    <div class="group-input">
                                        ...
                                        <select name="Other5_Department_person"
                                            ...
                                            <option value="0">-- Select --</option>
                                            <option @if (isset($data1) && $data1->Other5_Department_person == 'Production') selected @endif
                                                value="Production">Production</option>
                                            <option @if (isset($data1) && $data1->Other5_Department_person == 'Warehouse') selected @endif
                                                value="Warehouse"> Warehouse</option>
                                            ...
                                            <option @if (isset($data1) && $data1->Other5_Department_person == 'Quality_Assurance') selected @endif
                                                value="Quality_Assurance">Quality Assurance</option>
                                            <option @if (isset($data1) && $data1->Other5_Department_person == 'Engineering') selected @endif
                                                value="Engineering">Engineering</option>
                                ...
                                <div class="col-md-12 mb-3 Other5_reviews">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if ($data->stage == 3 || Auth::user()->id != isset($data1) && $data1->Other5_person) readonly @endif class="tiny"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Other5_Assessment)) readonly @endif
                                            name="Other5_Assessment"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
                                ...
                                <div class="col-md-12 mb-3 Other5_reviews">
                                    <div class="group-input">
                                        ...
                                        {{-- <textarea @if ($data->stage == 3 || Auth::user()->id != isset($data1) && $data1->Other5_person) readonly @endif class="tiny"
                                            ...
                                            @if (isset($data1) && $data1->Production_Review == 'yes' && $data->stage == 4) required @endif
                                            class="summernote Production_assessment"
                                            @if ($data->stage == 4 || (isset($data1) && $data1->Other5_feedback)) readonly @endif
                                            name="Other5_person"
                                            id="summernote-17"
                                        >{{ isset($data1) ? $data1->Production_assessment : '' }}</textarea>
