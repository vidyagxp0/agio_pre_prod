                    ...
                    <div class="mt-1 mb-2 bg-white" style="height: auto; padding: 10px;">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="filter-bar d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="filter-item">
                                        <label for="date_from_extension">Date From</label>
                                        <input type="date" class="custom-select form-control" id="date_from_extension">
                                    </div>
                                    <div class="filter-item">
                                        <label for="date_to_extension">Date To</label>
                                        <input type="date" class="custom-select form-control" id="date_to_extension">
                                    </div>
                    ...
                    <div class="table-block">
                        <div class="table-responsive" style="height: 500px">
                            <table class="table table-bordered" style="width: 120%;">
                                ...
                                <tbody id="tableData">
                                     @include('frontend.forms.Logs.filterData.extension_data')
                                </tbody>
                            </table>
...
<script>
    ...
    const filterData = {
        extension_department: null,
        div_idextension: null,
        period_lab: null,
        dateextensionFrom: null,
        dateextensionTo: null,
        // categoryofcomplaints: null
    };

    $('#initiator_group').change(function() {
        filterData.extension_department = $(this).val();
        filterRecords();
    });

    $('#division_id').change(function() {
        filterData.div_idextension = $(this).val();
        filterRecords();
    });
    ...
    $('#date_from_extension').change(function() {
        filterData.dateextensionFrom = $(this).val();
        filterRecords();
    });

    $('#date_to_extension').change(function() {
        filterData.dateextensionTo = $(this).val();
        filterRecords();
    });
