                    ...
                    <div class="mt-1 mb-2 bg-white" style="height: auto; padding: 10px;">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="filter-bar d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="filter-item">
                                        <label for="date_from_observation">Date From</label>
                                        <input type="date" class="custom-select form-control" id="date_from_observation">
                                    </div>
                                    <div class="filter-item">
                                        <label for="date_to_observation">Date To</label>
                                        <input type="date" class="custom-select form-control" id="date_to_observation">
                                    </div>
                    ...
                    <div class="table-block">
                        <div class="table-responsive" style="height: 500px">
                            <table class="table table-bordered" style="width: 120%;">
                                ...
                                <tbody id="tableData">
                                    @include('frontend.forms.Logs.filterData.observation_data')
                                </tbody>
                            </table>
...
<script>
    ...
    const filterData = {
        observation_department: null,
        div_idobservation: null,
        period_lab: null,
        dateobsertionFrom: null,
        dateobservationTo: null,
        // categoryofcomplaints: null
    };

    $('#initiator_group').change(function() {
        filterData.observation_department = $(this).val();
        filterRecords();
    });

    $('#division_id').change(function() {
        filterData.div_idobservation = $(this).val();
        filterRecords();
    });
    ...
    $('#date_from_observation').change(function() {
        filterData.dateobsertionFrom = $(this).val();
        filterRecords();
    });

    $('#date_to_observation').change(function() {
        filterData.dateobservationTo = $(this).val();
        filterRecords();
    });
    ...
    async function filterRecords() {
        ...
        try {
            const postUrl = "{{ route('api.observation.filter') }}";
