                    ...
                    <div class="mt-1 mb-2 bg-white" style="height: auto; padding: 10px;">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="filter-bar d-flex flex-wrap justify-content-between">
                                    ...
                                    <div class="filter-item">
                                        <label for="date_from_internalAudit">Date From</label>
                                        <input type="date" class="custom-select form-control" id="date_from_internalAudit">
                                    </div>
                                    <div class="filter-item">
                                        <label for="date_to_internalAudit">Date To</label>
                                        <input type="date" class="custom-select form-control" id="date_to_internalAudit">
                                    </div>
                                   {{-- <div class="filter-item">
...
<script>
    ...
    $('#date_from_internalAudit').change(function() {
        filterData.date_from = $(this).val();
        filterRecords();
    });

    $('#date_to_internalAudit').change(function() {
