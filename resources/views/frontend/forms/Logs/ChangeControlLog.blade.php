                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="filter-bar d-flex flex-wrap justify-content-between">
                                  ...
                                  <div class="filter-item">
                                    ...
                                    <div class="filter-item">
                                        <label for="date_from_changecontrol">Date From</label>
                                        <input type="date" class="custom-select form-control" id="date_from_changecontrol">
                                    </div>

                                    <div class="filter-item">
                                        <label for="date_to_changecontrol">Date To</label>
                                        <input type="date" class="custom-select form-control" id="date_to_changecontrol">
                                    </div>
                            ...
                            <table class="table table-bordered" style="width: 120%;">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="2">Description of Change Control</th>
                                        <th rowspan="2">Proposed Change </th>
                                        <th rowspan="2">Nature Of Change </th>
...
$('#nchange').change(function () {
    filterData.nchange = $(this).val();
    filterRecords();
});

$('#date_from_changecontrol').change(function () {
    filterData.date_from_changecontrol = $(this).val();
    filterRecords();
});

$('#date_to_changecontrol').change(function () {
    filterData.date_to_changecontrol = $(this).val();
    filterRecords();
});
