...
<script>
    window.openIncidentPrint = function () {
        const baseUrl = @json(
            route(
                'rcms.logs.print',
                ['slug' => 'incident']
        ...
        const departmentElement = document.getElementById('initiator_group');
        const divisionElement = document.getElementById('division_id');
        ...
        if (departmentElement && departmentElement.value) {
            params.append('department', departmentElement.value);
        }
        ...
        if (
            ...
            params.append('division_id', divisionElement.value);
        }

        if (dateFromElement && dateFromElement.value) {
            params.append('date_from', dateFromElement.value);
        }

        if (dateToElement && dateToElement.value) {
            params.append('date_to', dateToElement.value);
        }
