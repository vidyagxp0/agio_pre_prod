                ...
                @foreach($detail_data as $temp)
                    <div class="inner-block audit-main">
                        <div class="info-list">
                            ...
                            @if($temp->activity_type == "Repeat Nature" ||$temp->activity_type == "Nature Of Change" || $temp->activity_type== "Oot Occured On" || $temp->activity_type =="Oot Details" || $temp->activity_type == "Product History" || $temp->activity_type =="Probble Cause" )
