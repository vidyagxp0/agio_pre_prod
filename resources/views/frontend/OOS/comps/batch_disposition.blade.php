            ...
            <div class="col-12">
                <div class="group-input">
                    ...
                    <select name="material_batch_release_bd" {{Helpers::isOOSChemical($data->stage)}}>
                        <option value="" {{ $data->material_batch_release_bd == '' ? 'selected' : ''}}>Enter Your Selection Here</option>
                        <option value="To Be Released" {{ $data->material_batch_release_bd == 'To Be Released' ? 'selected' : ''}}>To Be Released</option>
                        <option value="To Be Rejected" {{ $data->material_batch_release_bd == 'To Be Rejected' ? 'selected' : ''}}>To Be Rejected</option>
                        <option value="other" {{ $data->material_batch_release_bd == 'other' ? 'selected' : ''}}>Other Action (Specify)</option>
                    </select>
                </div>
            </div>
