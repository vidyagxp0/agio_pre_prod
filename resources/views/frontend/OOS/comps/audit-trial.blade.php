            ...
            <div class="audit-trial-container">
                ...
                <div class="inner-block">
                    <div class="main-head">
                        ...
                        {{ Helpers::getDivisionName(session()->get('division')) }}/OOS Chemical/{{ date('Y') }}/{{ str_pad($document->record, 4, '0', STR_PAD_LEFT) }}</div>

                        <div class="btn-group">
                            <a href="{{ route('oos.audit_report',$document->id)}}"> <button type="button">Print</button></a>
                     </div>
                    </div>
                    <div class="info-list">
                        <div class="list-item">
                                ...
                                @foreach ($audit as $audits)
                                    <tr>
                                        <td class="viewdetails"><a
                                                href="{{ route('oos.audit_details', $audits->id) }}">{{ $audits->activity_type }}</a>
                                        </td>
