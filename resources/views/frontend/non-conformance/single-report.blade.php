    ...
    <div class="inner-block">
        <div class="content-table">
            <div class="block">
                ...
                <table>
                    <tr>
                        <th class="w-20"> Repeat Non Conformance?</th>
                        <td class="w-80">
                ...
                <table>
                    <tr>
                        <th class="w-20"> Non Conformance Observed On</th>
                        <td class="w-30">
                            @if ($data->non_conformances_date)
                                {{ \Carbon\Carbon::parse($data->non_conformances_date)->format('d-M-Y') }}
                            @else
                                Not Applicable
                            @endif
                        </td>

                        <th class="w-20"> Non Conformance Observed On (Time)</th>
                        <td class="w-30">
                            @if ($data->non_conformances_time)
                                {{ $data->non_conformances_time }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                ...
                <table>
                    ...
                    <tr>
                        <th class="w-20">Non Conformance Observed by</th>
                        @php
                ...
                <table>
                    <tr>
                        <th class="w-20">Non Conformance Reported On </th>
                        <td class="w-30">
                            @if ($data->non_conformances_reported_date)
                                {{ \Carbon\Carbon::parse($data->non_conformances_reported_date)->format('d-M-Y') }}
                            @else
                                Not Applicable
                            @endif
                        </td>

                        <th class="w-20">Non Conformance Related To</th>
                        <td class="w-30">
                            @if ($data->audit_type)
                                {{ $data->audit_type }}
                            @else
                ...
                <table>
                    <tr>
                        <th class="w-20">Description of Non Conformance</th>
                        <td class="w-80">
                            @if ($data->Description_non_conformanceS)
                                {{ strip_tags($data->Description_non_conformanceS) }}
                            @else
                                Not Applicable
                            @endif
                        </td>
                ...
                <table>
                    ...
                    <tr>
                        <th class="w-20">Preliminary Impact of Non Conformance</th>
                        <td class="w-80">
        ...
        <div class="block">
            ...
            <table>
                <tr>
                    <th class="w-20">Initial Non Conformance category</th>
                    <td class="w-80">
                        @if ($data->non_conformances_category)
                            {{ $data->non_conformances_category }}
                        @else
                            Not Applicable
                        @endif
                    </td>
                            ...
                            <td class="w-30">
                                <div>
                                    @if ($data1->Production_person)
                                        {{ Helpers::getInitiatorName($data1->Production_person) }}
                                    @else
                                        Not Applicable
                                    @endif
                                </div>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if ($data1->Warehouse_notification)
                                            {{ Helpers::getInitiatorName($data1->Warehouse_notification) }}
                                        @else
                                            Not Applicable
                                        @endif
                                    </div>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if ($data1->Quality_Control_Person)
                                            {{ Helpers::getInitiatorName($data1->Quality_Control_Person) }}
                                        @else
                                            Not Applicable
                                        @endif
                                    </div>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if ($data1->QualityAssurance_person)
                                            {{ Helpers::getInitiatorName($data1->QualityAssurance_person) }}
                                        @else
                                            Not Applicable
                                        @endif
                                    </div>
                                ...
                                <td class="w-30">
                                    <div>
                                        @if ($data1->Engineering_person)
                                            {{ Helpers::getInitiatorName($data1->Engineering_person) }}
                                        @else
                                            Not Applicable
                                        @endif
                                    </div>
                ...
                <div class="block">
                    <div class="head">
                        ...
                        <table>
                            ...
                            <tr>
                                <th class="w-20">Post Categorization Of Non Conformance</th>
                                <td class="w-80">
                                    <div>
                        ...
                        <div class="border-table" style="margin-bottom: 15px;">
                            ...
                            <table>
                                ...
                                <tr class="table_bg">
                                    <th class="w-5">S.N.</th>
                                    <th class="w-25">Investigation Team</th>
                                    <th class="w-25">Responsibility</th>
                                    <th class="w-25">Remarks</th>
                                </tr>
                                <tbody>
                                        ...
                                        @foreach ($investigation_data as $investigation_item)
                                            <tr>
                                                ...
                                                <option value="{{ $user->id }}"
                                                    ...
                                                    {{ $user->name }}</option>
                                            @endforeach
                                                <td class="w-25">{{ $investigation_item['responsibility'] }}</td>
                                                <td class="w-25">{{ $investigation_item['remarks'] }}</td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
                                            <td class="w-5">1</td>
                                            <td class="w-25">Not Applicable</td>
                                            <td class="w-25">Not Applicable</td>
                                            <td class="w-25">Not Applicable</td>
                                        </tr>
                                    @endif
                        ...
                        <div class="border-table" style="margin-bottom: 15px;">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if (is_array($why_data) && isset($why_data['problem_statement']))
                                                {{ $why_data['problem_statement'] }}
                                            @elseif (is_object($why_data) && property_exists($why_data, 'problem_statement'))
                                                {{ $why_data->problem_statement }}
                                            @else
                                                Not Applicable
                                            @endif
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if (is_array($why_data) && isset($why_data['root-cause']))
                                                {{ $why_data['root-cause'] }}
                                            @elseif (is_object($why_data) && property_exists($why_data, 'root-cause'))
                                                {{ $why_data->{"root-cause"} }}
                                            @else
                                                Not Applicable
                                            @endif
                            ...
                            <table>
                                ...
                                <tbody>
                                    @if ($why_data && isset($why_data->data['why_1']) && is_array($why_data->data['why_1']))
                                        @php
                                            $serialNumber = 1;
                                        @endphp
                            ...
                            <table>
                                ...
                                <tbody>
                                    @if ($why_data && isset($why_data->data['why_2']) && is_array($why_data->data['why_2']))
                                        @php
                                            $serialNumber = 1;
                                        @endphp
                            ...
                            <table>
                                ...
                                <tbody>
                                    @if ($why_data && isset($why_data->data['why_3']) && is_array($why_data->data['why_3']))
                                        @php
                                            $serialNumber = 1;
                                        @endphp
                            ...
                            <table>
                                ...
                                <tbody>
                                    @if ($why_data && isset($why_data->data['why_4']) && is_array($why_data->data['why_4']))
                                        @php
                                            $serialNumber = 1;
                                        @endphp
                            ...
                            <table>
                                ...
                                <tbody>
                                    @if ($why_data && isset($why_data->data['why_5']) && is_array($why_data->data['why_5']))
                                        @php
                                            $serialNumber = 1;
                                        @endphp
                                        @foreach ($why_data->data['why_5'] as $whyData)
                                            <tr>
                                                <td class="w-60">{{ $serialNumber++ }}</td>
                                                <td class="w-60">{{ $whyData }}</td>
                                            </tr>
                                        @endforeach
                                    @else
                        ...
                        <div class="border-table" style="margin-bottom: 15px;">
                            ...
                            <table>
                                <tr class="table_bg">
                                    <th class="w-5">S.N.</th>
                                    <th class="w-20">Gap Category</th>
                                    <th class="w-20">Issues</th>
                        ...
                        <div class="border-table" style="margin-bottom: 15px;">
                            ...
                            <table>
                                <tr class="table_bg">
                                    <th class="w-5">&nbsp;</th>
                                    <th class="w-20">Will Be</th>
                                    <th class="w-20">Will Not Be</th>
                                    <th class="w-20">Rationale</th>
                                </tr>
                        ...
                        <div class="border-table">
                            ...
                            <table>
                                ...
                                <tr class="table_bg">
                                    ...
                                    <th class="w-20">Review Schedule</th>
                                    <th class="w-20">Actual Reviewed On</th>
                                    <th class="w-20">Recorded By Sign and Date</th>
                                    <th class="w-20">Remark</th>
                                </tr>
                                <tbody>
                                    @if ($grid_data_matrix_qrms && is_array($grid_data_matrix_qrms->data))
                                        ...
                                        @foreach ($grid_data_matrix_qrms->data as $matrix_grid_data)
                                            <tr>
                                                <td class="w-5">{{ $serialNumber }}</td>
                                                <td class="w-20">{{ $matrix_grid_data['risk_Assesment'] }}</td>
                                                <td class="w-20">{{ $matrix_grid_data['review_schedule'] }}</td>
                                                <td class="w-20">{{ $matrix_grid_data['actual_reviewed'] }}</td>
                                                <td class="w-20">{{ $matrix_grid_data['recorded_by'] }}</td>
                                                <td class="w-20">{{ $matrix_grid_data['remark'] }}</td>
                                            </tr>
                                        @endforeach
                                    @else
                                        <tr>
