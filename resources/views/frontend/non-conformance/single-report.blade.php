    ...
    <div class="inner-block">
        <div class="content-table">
            <div class="block">
                ...
                <table>
                    <tr>
                        <th class="w-60">Facility/ Equipment/ Instrument/ System Details Required?</th>
                        <td class="w-80">
                        ...
                        <th class="w-40">Document Details Required?</th>
                        <td class="w-80">
        ...
        <div class="block">
            ...
            <table>
                <tr>
                    <th class="w-40">Initial Non Conformance category</th>
                    <td class="w-80">
                ...
                <tr>
                    <th class="w-40">Justification for categorization</th>
                    <td class="w-80">
            ...
            <div class="head">
                ...
                <div class="block">
                    <div class="head">
                        ...
                        <table>
                            ...
                            <tr>
                                <th class="w-60">Post Categorization Of Non Conformance</th>
                                <td class="w-80">
                                    <div>
                        ...
                        <table>
                            <tr>
                                <th class="w-60"> Justification For Revised category
                                </th>
                                <td class="w-80">
                                    <div>
                                    ...
                                    @if ($root_cause_data && is_array($root_cause_data->data))
                                        ...
                                        @foreach ($root_cause_data->data as $rootCause_data)
                                            <tr>
                                                ...
                                                <td class="w-20">{{ $rootCause_data['Root_Cause_Sub_Category'] }}
                                                </td>
                        ...
                        <div class="border-table" style="margin-bottom: 15px;">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if (is_array($why_data->data) && isset($why_data->data['problem_statement']))
                                                {{ $why_data->data['problem_statement'] }}
                                            @elseif (is_object($why_data->data) && property_exists($why_data->data, 'problem_statement'))
                                                {{ $why_data->data->problem_statement }}
                                            @else
                                                Not Applicable
                                            @endif
                                    ...
                                    <td class="w-30">
                                        <div>
                                            @if (is_array($why_data->data) && isset($why_data->data['root-cause']))
                                                {{ $why_data->data['root-cause'] }}
                                            @elseif (is_object($why_data->data) && property_exists($why_data->data, 'root-cause'))
                                                {{ $why_data->data->{"root-cause"} }}
                                            @else
                                                Not Applicable
                                            @endif
                ...
                <div class="block">
                    <div class="head">
                        ...
                        <table>
                            <tr>
                                <th class="w-40">Proposed Due Date </th>
                                <td class="w-80">
                                    <div>
