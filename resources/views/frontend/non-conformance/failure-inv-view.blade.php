            ...
            $('#risk-assessment-risk-management').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    var html =
                        ...
                        '<td> <select name="failure_mode_qrms[' + serialNumber + '][risk_acceptance_data]" id=""> <option value="">-- Select --</option><option value="n">N</option>   <option value="y">Y</option></select> </td>' +
...
<script>
    ...
    <div class="form-field-head">
        ...
        <div class="division-bar">
            ...
            {{ Helpers::getDivisionName(session()->get('division')) }}/Non Conformance
        </div>
    </div>

    <!-- Non Conformance Form Starts -->
    ...
    <div id="change-control-view">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <button class="button_theme1"> <a class="text-white"
                                href="{{ url('rcms/non-conformance-audit-trail', $data->id) }}">Audit Trail </a> </button>
        ...
        <div style="background: #e0903230;" id="change-control-fields">
            <div class="container-fluid">
                ...
                <form id="auditForm" action="{{ route('non-conformance-update', $data->id) }}" method="post"
                    ...
                    <div id="step-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            @if ($data->stage >= 3)
                                            <input disabled type="text" name="record" id="record" value="{{ Helpers::getDivisionName($data->division_id) }}/NOC/{{ date('Y') }}/{{ str_pad($data->record, 4, '0', STR_PAD_LEFT) }}">
                                    ...
                                    <div class="col-lg-6 new-date-data-field">
                                        <div class="group-input input-date">
                                            <label for="Short Description required">Repeat Non Conformance? <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-6">
                                        <div class="group-input">
                                            <label for="severity-level">Non Conformance Observed On <span
                                                    class="text-danger">*</span></label>
                                            <!-- <span class="text-primary">Severity levels in a QMS record gauge issue seriousness, guiding priority for corrective actions. Ranging from low to high, they ensure quality standards and mitigate critical risks.</span> -->
                                            <input type="date" id="non_conformances_date"  max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                name="non_conformances_date"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                                value="{{ old('non_conformances_date') ? old('non_conformances_date') : $data->non_conformances_date }}">
                                            @error('non_conformances_date')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    <div class="col-lg-6 new-time-data-field">
                                        <div class="group-input input-time">
                                            <label for="non_conformances_time">Non Conformance Observed On (Time) <span
                                                    class="text-danger">*</span></label>
                                            <input type="text"
                                                name="non_conformances_time"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                                id="non_conformances_time"
                                                value="{{ old('non_conformances_time') ? old('non_conformances_time') : $data->non_conformances_time }}">
                                            @error('non_conformances_time')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <label for="If Other">Non Conformance Observed By<span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="Initiator Group">Non Conformance Reported On <span
                                                    class="text-danger">*</span></label>
                                            <!-- <div><small class="text-primary">Please select related information</small></div> -->
                                            <input type="date" id="non_conformances_reported_date"
                                                max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                name="non_conformances_reported_date"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                                value="{{ $data->non_conformances_reported_date }}">
                                        </div>
                                        @error('non_conformances_reported_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            <label for="audit type">Non Conformance Related To <span
                                                    class="text-danger">*</span></label>
                                            <select multiple
                                    ...
                                    <div class="col-md-12">
                                        <div class="group-input">
                                            <label for="Description Non Conformance">Description of Non Conformance <span
                                                    class="text-danger">*</span></label>
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                                            <textarea class="tiny1"name="Description_non_conformanceS"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }} id="summernote-1">{{ $data->Description_non_conformanceS }}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="group-input">
                                            ...
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                                            <textarea class="tiny1" name="Immediate_Action[]" {{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                    ...
                                    <div class="col-md-12">
                                        <div class="group-input">
                                            <label for="Preliminary Impact">Preliminary Impact of Non Conformance <span
                                                    class="text-danger">*</span></label>
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                                            <textarea class="tiny1" name="Preliminary_Impact[]"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                        ...
                        <script>
                            ...
                            // Function to handle the change event of the Initial Non Conformance Category dropdown
                            function handleFailureInvestigationCategoryChange() {
                                var selectElement = document.getElementById("non_conformances_category");
                        ...
                        <script>
                            ...
                            $(document).ready(function() {
                                $('#non_conformances_category, #Investigation_required, #qrm_required, #capa_required').change(
                                    function() {
                                        // Get the selected values
                                        var non_conformancesCategory = $('#non_conformances_category').val();
                            ...
                            $(document).ready(function() {
                                $('#non_conformances_category').change(function() {
                                    var selectedValues = $(this).val();
                                    ...
                                    <div class="row">
                                        ...
                                        <div style="margin-bottom: 0px;" class="col-lg-12 new-date-data-field ">
                                            <div class="group-input input-date">
                                                ...
                                                @if ($data->stage == 3)
                                                    <label for="Non Conformance category">Non Conformance category <span
                                                            class="text-danger">*</span></label>
                                                    <select id="non_conformances_category"
                                                        name="non_conformances_category"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                                        value="{{ $data->non_conformances_category }}"
                                                        onchange="handleFailureInvestigationCategoryChange()" required>
                                                        <option value="0">-- Select --</option>
                                                        <option @if ($data->non_conformances_category == 'minor') selected @endif
                                                            value="minor">Minor</option>
                                                        <option @if ($data->non_conformances_category == 'major') selected @endif
                                                            value="major">Major</option>
                                                        <option @if ($data->non_conformances_category == 'critical') selected @endif
                                                            value="critical">Critical</option>
                                                    </select>
                                                @else
                                                    <label for="Non Conformance category">Non Conformance category</label>
                                                    <select id="non_conformances_category"
                                                        name="non_conformances_category"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                                ...
                                                @error('non_conformances_category')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
                                ...
                                <div style="margin-bottom: 0px;" class="col-lg-12 new-date-data-field ">
                                    <div class="group-input input-date">
                                        @if ($data->stage == 3)
                                            <label for="Non Conformance category">Non Conformance category <span
                                                    class="text-danger">*</span></label>
                                            <select disabled id="non_conformances_category"
                                                name="non_conformances_category"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                                value="{{ $data->non_conformances_category }}">
                                                <option value="0">-- Select --</option>
                                                <option @if ($data->non_conformances_category == 'minor') selected @endif value="minor">
                                                    Minor</option>
                                                <option @if ($data->non_conformances_category == 'major') selected @endif value="major">
                                                    Major</option>
                                                <option @if ($data->non_conformances_category == 'critical') selected @endif
                                                    value="critical">Critical</option>
                                            </select>
                                    ...
                                    @if ($data->stage == 4)
                                        <div class="col-md-12 mb-3 p_erson">
                                            <div class="group-input">
                                                ...
                                                <div><small class="text-primary">Please insert "NA" in the data field if it
                                                        does not require completion</small></div>
                                                <textarea class="tiny1" name="Production_assessment" id="summernote-17">{{ $data1->Production_assessment }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3 p_erson">
                                            <div class="group-input">
                                                ...
                                                <div><small class="text-primary">Please insert "NA" in the data field if it
                                                        does not require completion</small></div>
                                                <textarea class="tiny1" name="Production_feedback" id="summernote-18">{{ $data1->Production_feedback }}</textarea>
                                            </div>
                                        </div>
                                    @else
                                        <div class="col-md-12 mb-3 p_erson">
                                            <div class="group-input">
                                                ...
                                                <div><small class="text-primary">Please insert "NA" in the data field if it
                                                        does not require completion</small></div>
                                                <textarea disabled class="tiny1" name="Production_assessment" id="summernote-17">{{ $data1->Production_assessment }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3 p_erson">
                                            <div class="group-input">
                                                ...
                                                <div><small class="text-primary">Please insert "NA" in the data field if it
                                                        does not require completion</small></div>
                                                <textarea disabled class="tiny1" name="Production_feedback" id="summernote-18">{{ $data1->Production_feedback }}</textarea>
                                            </div>
                                        </div>
                                    @endif
                                    <div class="col-12 p_erson">
                                    ...
                                    @if ($data->stage == 4)
                                        <div class="col-md-12 mb-3 warehouse">
                                            <div class="group-input">
                                                ...
                                                <textarea class="tiny1" name="Warehouse_assessment" id="summernote-19">{{ $data1->Warehouse_assessment }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12 mb-3 warehouse">
                                            <div class="group-input">
                                                ...
                                                <div><small class="text-primary">Please insert "NA" in the data field if
                                                        it does not require completion</small></div>
                                                <textarea class="tiny1" name="Warehouse_feedback" id="summernote-20">{{ $data1->Warehouse_feedback }}</textarea>
                                            </div>
                                        </div>
                            </div>
                        @else
                            <div class="col-md-12 mb-3 warehouse">
                                <div class="group-input">
                                    ...
                                    <textarea disabled class="tiny1" name="Warehouse_assessment" id="summernote-19">{{ $data1->Warehouse_assessment }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12 mb-3 warehouse">
                                <div class="group-input">
                                    ...
                                    <div><small class="text-primary">Please insert "NA" in the data field if it does not
                                            require completion</small></div>
                                    <textarea disabled class="tiny1" name="Warehouse_feedback" id="summernote-20">{{ $data1->Warehouse_feedback }}</textarea>
                                </div>
                            </div>
                            @endif
                            <div class="col-12 warehouse">
                                    ...
                                    <div class="group-input">
                                        <label for="Impact Assessment8">Impact Assessment (By Environment, Health &
                                            Safety) <span id="asteriskEH1"
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Environment_Health_review == 'yes' && $data->stage == 4) required @endif class="tiny1" name="Health_Safety_assessment"
                                ...
                                <div class="col-md-12 mb-3 environmental_health">
                                    <div class="group-input">
                                        <label for="Safety Feedback">Environment, Health & Safety Feedback <span
                                                ...
                                                style="display: {{ $data1->Environment_Health_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Environment_Health_review == 'yes' && $data->stage == 4) required @endif class="tiny1" name="Health_Safety_feedback"
                                ...
                                <div class="col-md-12 mb-3 other1_reviews ">
                                    <div class="group-input">
                                        <label for="Impact Assessment12">Impact Assessment (By Other's 1) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Other1_review == 'yes' && $data->stage == 4) required @endif class="tiny1" name="Other1_assessment"
                                ...
                                <div class="col-md-12 mb-3 other1_reviews ">
                                    <div class="group-input">
                                        <label for="Feedback1"> Other's 1 Feedback <span id=""
                                                style="display: {{ $data1->Other1_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data1->Other1_review == 'yes' && $data->stage == 4) required @endif class="tiny1" name="Other1_feedback"
                                ...
                                <div class="col-md-12 mb-3 Other2_reviews">
                                    <div class="group-input">
                                        <label for="Impact Assessment13">Impact Assessment (By Other's 2) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other2_person) readonly @endif class="tiny1" name="Other2_Assessment"
                                ...
                                <div class="col-md-12 mb-3 Other2_reviews">
                                    <div class="group-input">
                                        <label for="Feedback2"> Other's 2 Feedback <span id=""
                                                style="display: {{ $data1->Other2_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other2_person) readonly @endif class="tiny1" name="Other2_feedback"
                                ...
                                <div class="col-md-12 mb-3 Other3_reviews">
                                    <div class="group-input">
                                        <label for="Impact Assessment14">Impact Assessment (By Other's 3) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other3_person) readonly @endif class="tiny1" name="Other3_Assessment"
                                ...
                                <div class="col-md-12 mb-3 Other3_reviews">
                                    <div class="group-input">
                                        <label for="feedback3"> Other's 3 Feedback <span id=""
                                                style="display: {{ $data1->Other3_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other3_person) readonly @endif class="tiny1" name="Other3_feedback"
                                ...
                                <div class="col-md-12 mb-3 Other4_reviews">
                                    <div class="group-input">
                                        <label for="Impact Assessment15">Impact Assessment (By Other's 4) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other4_person) readonly @endif class="tiny1" name="Other4_Assessment"
                                ...
                                <div class="col-md-12 mb-3 Other4_reviews">
                                    <div class="group-input">
                                        <label for="feedback4"> Other's 4 Feedback <span id=""
                                                style="display: {{ $data1->Other4_review == 'yes' && $data->stage == 4 ? 'inline' : 'none' }}"
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other4_person) readonly @endif class="tiny1" name="Other4_feedback"
                                ...
                                <div class="col-md-12 mb-3 Other5_reviews">
                                    <div class="group-input">
                                        <label for="Impact Assessment16">Impact Assessment (By Other's 5) <span
                                                ...
                                                class="text-danger">*</span></label>
                                        <textarea @if ($data->stage == 3 || Auth::user()->id != $data1->Other5_person) readonly @endif class="tiny1"
                ...
                <div class="row">
                                ...
                                <table class="table table-bordered" style="width: 200%"
                                    ...
                                    <tbody>
                                        ...
                                        @if ($grid_data_qrms && is_array($grid_data_qrms))
                                            @foreach ($grid_data_qrms as $grid_data_qrms)
                                                <tr>
                                                    ...
                                                    <td><input disabled type="text"name="serial[]" {{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }} value="{{ $loop->index + 1 }}"></td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="numberDetail"
                                                            name="failure_mode_qrms[{{ $loop->index }}][initial_rpn]"value="{{ isset($grid_data_qrms['initial_rpn']) ? $grid_data_qrms['initial_rpn'] : '' }}">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="numberDetail"
                                                            name="failure_mode_qrms[{{ $loop->index }}][proposed_additional_risk_control]" value="{{ isset($grid_data_qrms['proposed_additional_risk_control']) ? $grid_data_qrms['proposed_additional_risk_control'] : '' }}">
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="numberDetail"
                                                            name="failure_mode_qrms[{{ $loop->index }}][residual_rpn]" value="{{ isset($grid_data_qrms['residual_rpn']) ? $grid_data_qrms['residual_rpn'] : '' }}">
                                                    </td>

                                                    <td>
                                                        <select name="failure_mode_qrms[{{ $loop->index }}][risk_acceptance_data]" id="">
                                                            <option value="">-- Select --</option>
                                                            <option value="n"
                                                                {{ isset($grid_data_qrms['risk_acceptance_data']) && $grid_data_qrms['risk_acceptance_data'] == 'n' ? 'selected' : '' }}>
                                                                N</option>
                                                            <option value="y"
                                                                {{ isset($grid_data_qrms['risk_acceptance_data']) && $grid_data_qrms['risk_acceptance_data'] == 'y' ? 'selected' : '' }}>
                                                                Y</option>
                                                    </td>

                                                    <td>
                                                        <input type="text" class="numberDetail"
                                                            name="failure_mode_qrms[{{ $loop->index }}][mitigation_proposal]"  value="{{ isset($grid_data_qrms['mitigation_proposal']) ? $grid_data_qrms['mitigation_proposal'] : '' }}">
                                                    </td>
                                        ...
                                        @else
                                            ...
                                            <td>
                                                <select name="failure_mode_qrms[0][risk_acceptance_data]" id="">
                                                    <option value="">-- Select --</option>
                                                    <option value="n" ($grid_data_qrms && isset($grid_data_qrms['risk_acceptance_data']=='n' ? 'selected'
                                                        : '' ))>N</option>
                                                    <option value="y" ($grid_data_qrms && isset($grid_data_qrms['risk_acceptance_data']=='y' ? 'selected'
                                                        : '' ))>Y</option>
                                                </select>
                                            </td>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny1" name="Conclusion" id="summernote-8" value="{{$data->Conclusion}}">{{$data->Conclusion}}    </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny1" name="Identified_Risk" value="{{$data->Identified_Risk}}" id="summernote-8">{{$data->Identified_Risk}} </textarea>
                        </div>
                    </div>
        ...
        @foreach ($grid_data_matrix_qrms as $grid_data_matrix_qrms)
            <tr>
                ...
                <td><input disabled type="text"name="serial[]"
                        {{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }} value="{{ $key + 0 }}">
                </td>
    ...
    <div id="CCForm10" class="inner-block cctabcontent">
        <div class="inner-block-content">
            <div class="row">
                ...
                <div style="margin-bottom: 0px;" class="col-lg-12 new-date-data-field ">
                    <div class="group-input input-date">
                        <label for="Non Conformance category">Source of CAPA</label>
                        <select name="source_of_capa" id="non_conformances_category"
                         @if ($data->stage==4) disabled @endif id="non_conformances_category" value="{{ $data->source_of_capa }}">
                            <option value="0">-- Select -- </option>
                            <option @if ($data->source_of_capa == 'FailureInvestigation') selected @endif
                                                value="FailureInvestigation">Non Conformance</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="tiny1" name="Investigation_Summary"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }} id="summernote-8">{{ $data->Investigation_Summary }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="tiny1" name="Impact_assessment"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }} id="summernote-9">{{ $data->Impact_assessment }}</textarea>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="tiny1" name="Root_cause" {{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}  id="summernote-10">{{ $data->Root_cause }}</textarea>
                                    </div>
                                    @error('Root_cause')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        <label for="Post Categorization Of Deviation">Post Categorization Of Non Conformance <span style="display: {{ $data->stage == 5 ? 'inline' : 'none' }}" class="text-danger">*</span></label>
                                        <div><small class="text-primary">Please Refer Intial Non Conformance category before updating.</small></div>
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea class="tiny1" name="Investigation_Of_Review"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}  id="summernote-13">{{ $data->Investigation_Of_Review }}</textarea>
                                    </div>
                                    @error('Post_Categorization')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea readonly class="tiny1" name="Investigation_Summary"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }} id="summernote-8">{{ $data->Investigation_Summary }}</textarea>
                                    </div>
                                    @error('Investigation_Summary')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea readonly class="tiny1" name="Impact_assessment"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }} id="summernote-9">{{ $data->Impact_assessment }}</textarea>
                                    </div>
                                    @error('Impact_assessment')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea readonly class="tiny1" name="Root_cause"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}  id="summernote-10">{{ $data->Root_cause }}</textarea>
                                    </div>
                                    @error('Root_cause')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea readonly class="tiny1" name="CAPA_Description"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}  id="summernote-11">{{ $data->CAPA_Description }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                        <textarea readonly class="tiny1" name="Investigation_Of_Review"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}  id="summernote-13">{{ $data->Investigation_Of_Review }}</textarea>
                                    </div>
                                    @error('Post_Categorization')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                    ...
                    <div class="col-md-12">
                        @if ($data->stage == 5)
                            <div class="group-input">
                                ...
                                <div><small class="text-primary">Please insert "NA" in the data field if it does not
                                        require completion</small></div>
                                <textarea class="tiny1" name="QA_Feedbacks"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
        ...
        <div id="CCForm5" class="inner-block cctabcontent">
            <div class="inner-block-content">
                <div class="row">
                    <div class="col-md-12">
                        <div class="group-input">
                            <label for="Post Categorization Of Non Conformance">Post Categorization Of Non Conformance</label>
                            <div><small class="text-primary">Please Refer Intial Non Conformance category before
                                    updating.</small></div>
                            <select
                    ...
                    <div class="col-md-12">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea @if ($data->stage != 6) disabled @endif required class="tiny1"
                    ...
                    <div class="col-md-12">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea @if ($data->stage != 6) readonly @endif required class="tiny1"
        ...
        <div id="CCForm12" class="inner-block cctabcontent">
            <div class="inner-block-content">
                <div class="row">
                    ...
                    @else
                        <div class="col-md-12 mb-3">
                            <div class="group-input">
                                <label for="Extension_Justification_non_conformances">Extension Justification (Non Conformance)</label>
                                <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                <textarea name="dev_extension_justification" placeholder="Non Conformance Extension Justification" id="dev_extension_justification" disabled ></textarea>
                            </div>
                        </div>
                    @endif
                    ...
                    <!-- <div class="sub-head">
                        Non Conformance Effectiveness Check
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            <label for="Effectiveness_Check_Plan_non_conformances">Effectiveness Check Plan(Non Conformance)</label>
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny1" name="Effectiveness_Check_Plan_non_conformances" id="summernote-10"> </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label for=" non_conformances_Effectiveness_Check_Plan_Proposed_By">Non Conformance Effectiveness Check
                                    Plan Proposed By </label>
                                <select name="non_conformances_Effectiveness_Check_Plan_Proposed_By"
                                    id="non_conformances_Effectiveness_Check_Plan_Proposed_By">
                                    <option value="">-- Select --</option>
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}">{{ $user->name }}</option>
                                    @endforeach
                        ...
                        <div class="col-lg-6 new-date-data-field">
                            <div class="group-input input-date">
                                <label for="non_conformances_EC_Plan_Proposed_On"> Non Conformance Effectiveness Check Plan Proposed
                                    On</label>
                                <div class="calenderauditee">
                                    <input type="text" id="non_conformances_EC_Plan_Proposed_On" readonly
                                        placeholder="DD-MMM-YYYY" />
                                    <input type="date" name="non_conformances_EC_Plan_Proposed_On"
                                        max="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" class="hide-input"
                                        oninput="handleDateInput(this, 'non_conformances_EC_Plan_Proposed_On')" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            <label for="EC_Closure_comments_non_conformances">Effectiveness Check Closure
                                Comments(Non Conformance)</label>
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny1" name="EC_Closure_comments_non_conformances" id="summernote-10"> </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6 new-date-data-field">
                        <div class="group-input input-date">
                            <label for="Next_review_date_non_conformances">Next Review Date(Non Conformance)</label>
                            <div class="calenderauditee">
                                <input type="text" id="Next_review_date_non_conformances" readonly
                                    placeholder="DD-MMM-YYYY" />
                                <input type="date" name="Next_review_date_non_conformances"
                                    min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" class="hide-input"
                                    oninput="handleDateInput(this, 'Next_review_date_non_conformances')" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label for=" deviaiton_EC_Closed_By">Non Conformance Effectiveness Check Closed By</label>
                        ...
                        <div class="col-lg-6 new-date-data-field">
                            <div class="group-input input-date">
                                <label for="non_conformances_Effectiveness_Check_Closed_On">Non Conformance Effectiveness Check Closed
                                    On</label>
                                <div class="calenderauditee">
                                    <input type="text" id="non_conformances_Effectiveness_Check_Closed_On" readonly
                                        placeholder="DD-MMM-YYYY" />
                                    <input type="date" name="non_conformances_Effectiveness_Check_Closed_On"
                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" class="hide-input"
                                        oninput="handleDateInput(this, 'non_conformances_Effectiveness_Check_Closed_On')" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny1" name="EC_plan_Capa" id="summernote-10">
                </textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny1" name="Extension_Justi_QRM" id="summernote-10">
                </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6 new-date-data-field">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny1" name="EC_Closure_Comments_investigation" id="summernote-10">
                </textarea>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-titles">Non Conformance Workflow</h4>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('launch-extension-qrm', $data->id) }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input name="non_conformances_id" id="non_conformances_id" value="{{$data->id}}" hidden >
...
<div class="modal fade" id="non_conformances_extension">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Non Conformance Extension</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <form action="{{ route('launch-extension-non-conformance', $data->id) }}" method="post">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <!-- <div class="group-input">
                    ...
                    <div class="group-input">
                        <label for="password">Proposed Due Date (Non Conformance)</label>
                        <input class="extension_modal_signature" type="date" name="dev_proposed_due_date" id="dev_proposed_due_date">
                    </div>
                    <div class="group-input">
                        <label for="password">Extension Justification (Non Conformance)<span
                                class="text-danger">*</span></label>
                        <input class="extension_modal_signature" type="text"
                            name="dev_extension_justification" id="dev_extension_justification">
                    </div>
                    <div class="group-input">
                        <label for="password">Non Conformance Extension Completed By </label>
                    ...
                    <div class="group-input">
                        <label for="password">Non Conformance Extension Completed On </label>
                        <input class="extension_modal_signature" type="date" name="dev_completed_on" id="dev_completed_on">
                    </div>
                    <input name="non_conformances_id" id="non_conformances_id" value="{{$data->id}}" hidden  >
                    <input name="extension_identifier" id="extension_identifier" value="Non Conformance"  hidden >
                </div>
                        ...
                        <ul>
                            <li>
                                <div> <a href="" data-bs-toggle="modal"
                                        data-bs-target="#non_conformances_effectiveness"> Non Conformance Effectiveness
                                        Check</a></div>
                            </li>
...
<div class="modal fade" id="non_conformances_effectiveness">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Non Conformance Effectiveness</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            ...
            <form>
                ...
                <div class="modal-body">
                    ...
                    <div class="group-input">
                        <label for="Non Conformance">Effectiveness Check Plan(Non Conformance)</label>
                        <input class="extension_modal_signature" type="date"
                            name="effectiveness_non_conformances">
                    </div>
                    <div class="group-input">
                        <label for="password">Non Conformance Effectiveness Check Plan Proposed By<span
                                class="text-danger">*</span></label>
                        <input class="extension_modal_signature" type="text"
                            name="effectiveness_non_conformances_proposed_by">
                    </div>
                    <div class="group-input">
                        <label for="password">Non Conformance Effectiveness Check Plan Proposed On </label>
                        <input class="extension_modal_signature" type="text"
                            name="non_conformances_effectiveness_by">
                    </div>
                    <div class="group-input">
                        <label for="password">Effectiveness Check Colsure Comments(Non Conformance)</label>
                        <input class="extension_modal_signature" type="date"
                            name="non_conformances_effectiveness_on">
                    </div>
                    <div class="group-input">
                        <label for="password">Next Review Date(Non Conformance)</label>
                        <input class="extension_modal_signature" type="date" name="next_review_non_conformances">
                    </div>
                    <div class="group-input">
                        <label for="password">Non Conformance Effectiveness Check closed By </label>
                        <select class="extension_modal_signature" name="non_conformances_feectiveness_closed_by"
                            id="">
                            <option value="">-- Select --</option>
                        </select>
                    </div>
                    <div class="group-input">
                        <label for="password">Non Conformance Effectiveness Check CLosed On</label>
                        <input class="extension_modal_signature" type="date"
                            name="non_conformances_effectiveness_on">
                    </div>
            ...
            <form>
                ...
                <div class="modal-body">
                    ...
                    <div class="group-input">
                        ...
                        <input class="extension_modal_signature" type="date" name="non_conformances_due_capa">
                    </div>
                    <div class="group-input">
...
<div class="modal fade" id="investigation_effectiveness">
    ...
    <div class="modal fade" id="child-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('non_conformances_child_1', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="group-input">
    ...
    <div class="modal fade" id="cancel-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('failureInvestigationCancel', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="mb-3 text-justify">
    ...
    <div class="modal fade" id="failureInvestigationIsCFTRequired">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('failureInvestigationIsCFTRequired', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="mb-3 text-justify">
    ...
    <div class="modal fade" id="modal1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('failureInvestigationQaMoreInfo', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="mb-3 text-justify">
