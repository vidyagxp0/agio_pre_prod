                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        @php
                            ...
                            foreach ($columns as $column) {
    // Check if $cftUsers is not null before accessing its properties
    if ($cftUsers) {
        // Access the Production_person property
        $value = $cftUsers->Production_person;
        ...
        // Handle the case where $cftUsers is null (optional)
        error_log("cftUsers is null for column: $column");
    }
}
    ...
    <div id="CCForm10" class="inner-block cctabcontent">
        <div class="inner-block-content">
            <div class="row">
                ...
                <!-- <div class="col-lg-12">
                                    <div class="group-input">
                                        <label for="Department1"> Other's 1 Department  <span id="asteriskod1"  style="display: {{ isset($data1) && $data1->Other1_review == 'yes' ? 'inline' : 'none' }}"  class="text-danger">*</span> </label>
                                    
                                        <select name="Other1_Department_person"
                                         @if ($data->stage==4) disabled @endif id="Other1_Department_person" value="{{ isset($data1) ? $data->Other1_Department_person : '' }}">
                                            <option value="0">-- Select --</option>
                                            <option @if (isset($data1) ? $data1->Other1_Department_person == 'Production': '') selected @endif
                                                value="Production">Production</option>
                                            <option  @if (isset($data1) ? $data->Other1_Department_person == 'Warehouse': '') selected @endif
                                               value="Warehouse"> Warehouse</option>
                                            <option  @if (isset($data1) ? $data->Other1_Department_person == 'Project management':'') selected @endif
