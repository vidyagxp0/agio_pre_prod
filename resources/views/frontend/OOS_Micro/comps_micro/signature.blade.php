                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->Submite_by }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Audit Agenda">Submited on</label>
                                <div class="Date">{{ $micro_data->Submite_on }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">Comment</label>
                            <div class="Date">{{ $micro_data->Submite_comment }}</div>
                           </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                     ...
                     <!-- Request More Info -->
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->HOD_Primary_Review_Complete_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Audit Team">HOD Primary Review Complete On</label>
                                <div class="Date">{{ $micro_data->HOD_Primary_Review_Complete_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">HOD Primary Review Complete Comment</label>
                            <div class="Date">{{ $micro_data->HOD_Primary_Review_Complete_Comment }}</div>
                           </div>
                        </div>
                    <div>
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->Phase_IA_Investigation_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Audit Attachments">Phase IA Investigation On</label>
                                <div class="Date">{{ $micro_data->Phase_IA_Investiigation_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">Phase IA Investigation Comment</label>
                            <div class="Date">{{ $micro_data->Phase_IA_Investigation_Comment }}</div>
                           </div>
                        </div>
                    <div>
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->Phase_IA_HOD_Review_Complete_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Audit Attachments">Phase IA HOD Review Complete On</label>
                                <div class="Date">{{ $micro_data->Phase_IA_HOD_Review_Complete_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">Phase IA HOD Review Complete Comment</label>
                            <div class="Date">{{ $micro_data->Phase_IA_HOD_Review_Complete_Comment }}</div>
                           </div>
                        </div>
                        <!-- Request More Info -->
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class=" static">{{ $micro_data->Assignable_Cause_Not_Found_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Audit Attachments">Assignable Cause Not Found On</label>
                                <div class="date">{{ $micro_data->Assignable_Cause_Not_Found_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">Assignable Cause Not Found Comment</label>
                            <div class="Date">{{ $micro_data->Assignable_Cause_Not_Found_Comment }}</div>
                           </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class=" static">{{ $micro_data->Assignable_Cause_Found_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Audit Attachments">Assignable Cause Found On</label>
                                <div class="date">{{ $micro_data->Assignable_Cause_Found_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">Assignable Cause Found Comment</label>
                            <div class="Date">{{ $micro_data->Assignable_Cause_Found_Comment }}</div>
                           </div>
                        </div>
                    <div>
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class=" static">{{ $micro_data->Phase_IB_Investigation_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Audit Attachments">Phase IB Investigation On</label>
                                <div class="date">{{ $micro_data->Phase_IB_Investigation_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">Phase IB Investigation Comment</label>
                            <div class="Date">{{ $micro_data->Phase_IB_Investigation_Comment }}</div>
                           </div>
                        </div>
                        <!-- Request More Info -->
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class=" static">{{ $micro_data->Phase_IB_HOD_Review_Complete_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Audit Attachments">Phase IB HOD Review Complete On</label>
                                <div class="date">{{ $micro_data->Phase_IB_HOD_Review_Complete_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">Phase IB HOD Review Complete Comment</label>
                            <div class="Date">{{ $micro_data->Phase_IB_HOD_Review_Complete_Comment }}</div>
                           </div>
                        </div>
                    <div>
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class=" static">{{ $micro_data->P_I_B_Assignable_Cause_Not_Found_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Reference Recores">P-I B Assignable Cause Not Found On </label>
                                <div class="date">{{ $micro_data->P_I_B_Assignable_Cause_Not_Found_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">P-I B Assignable Cause Not Found Comment</label>
                            <div class="Date">{{ $micro_data->P_I_B_Assignable_Cause_Not_Found_Comment }}</div>
                           </div>
                        </div>
                         <!-- Request More Info -->
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->P_I_B_Assignable_Cause_Found_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Reference Recores">P-I B Assignable Cause Found On</label>
                                <div class="date">{{ $micro_data->P_I_B_Assignable_Cause_Found_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">P-I B Assignable Cause Found Comment</label>
                            <div class="Date">{{ $micro_data->P_I_B_Assignable_Cause_Found_Comment }}</div>
                           </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class=" static">{{ $micro_data->Phase_II_A_Investigation_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Reference Recores">Phase II A Investigation On</label>
                                <div class="date">{{ $micro_data->Phase_II_A_Investigation_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">Phase II A Investigation Comment</label>
                            <div class="Date">{{ $micro_data->Phase_II_A_Investigation_Comment }}</div>
                           </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class=" static">{{ $micro_data->Phase_II_A_HOD_Review_Complete_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="Reference Recores">Phase II A HOD Review Complete On </label>
                                <div class="date">{{ $micro_data->Phase_II_A_HOD_Review_Complete_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">Phase II A HOD Review Complete Comment</label>
                            <div class="Date">{{ $micro_data->Phase_II_A_HOD_Review_Complete_Comment }}</div>
                           </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->P_II_A_Assignable_Cause_Not_Found_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="submitted on">P-II A Assignable Cause Not Found On</label>
                                <div class="Date">{{ $micro_data->P_II_A_Assignable_Cause_Not_Found_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">P-II A Assignable Cause Not Found Comment</label>
                            <div class="Date">{{ $micro_data->P_II_A_Assignable_Cause_Not_Found_Comment }}</div>
                           </div>
                        </div>
                        <!-- Request More Info -->
                        <!-- Approval Completed -->
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->P_II_A_Assignable_Cause_Found_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="completed on"> P-II A Assignable Cause Found On</label>
                                <div class="Date">{{ $micro_data->P_II_A_Assignable_Cause_Found_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->Phase_II_B_Investigation_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="completed on"> Phase II B Investigation On</label>
                                <div class="Date">{{ $micro_data->Phase_II_B_Investigation_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->Phase_II_B_HOD_Review_Complete_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="completed on"> Phase II B HOD Review Complete On</label>
                                <div class="Date">{{ $micro_data->Phase_II_B_HOD_Review_Complete_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                        ...
                        <div class="col-lg-4">
                            <div class="group-input">
                                ...
                                <div class="static">{{ $micro_data->P_II_B_Assignable_Cause_Not_Found_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="completed on">P-II B Assignable Cause Not Found On</label>
                                <div class="Date">{{ $micro_data->P_II_B_Assignable_Cause_Not_Found_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">P-II B Assignable Cause Not Found Comment</label>
                            <div class="Date">{{ $micro_data->P_II_B_Assignable_Cause_Not_Found_Comment }}</div>
                           </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="completed by">P-II B Assignable Cause Found By</label>
                                <div class="static">{{ $micro_data->P_II_B_Assignable_Cause_Found_By }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="group-input">
                                <label for="completed on">P-II B Assignable Cause Found On</label>
                                <div class="Date">{{ $micro_data->P_II_B_Assignable_Cause_Found_On }}</div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                           <div class="group-input">
                            <label for="Submitted on">P-II B Assignable Cause Found Comment</label>
                            <div class="Date">{{ $micro_data->P_II_B_Assignable_Cause_Found_Comment }}</div>
                           </div>
                        </div>
                    </div>
