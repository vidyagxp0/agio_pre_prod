            ...
            <div class="inner-block-content">
                <div class="row">
                    ...
                    <div class="button-block">
                        <button style=" justify-content: center; width: 4rem; margin-left: 1px;;" type="submit" class="saveButton" {{ $micro_data->stage == 9 ? 'disabled' : '' }}>Save</button>
                        ...
                        <button style=" justify-content: center; width: 4rem; margin-left: 1px;;" type="button"> <a href="{{ url('rcms/qms-dashboard') }}" class="text-white">
                                Exit </a> </button>
                                {{-- @if ($micro_data->stage == 2 || $micro_data->stage == 3 || $micro_data->stage == 4 || $micro_data->stage == 5 || $micro_data->stage == 6 || $micro_data->stage == 7 )
