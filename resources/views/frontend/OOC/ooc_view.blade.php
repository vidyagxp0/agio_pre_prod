                                    ...
                                    <div class="group-input">
                                        ...
                                        <select id="select-state" placeholder="Select..." name="assign_to"
                                            ...
                                            @foreach ($users as $key => $value)
                                                <option @if ($ooc->assign_to == $value->id) selected @endif
                                ...
                                <div class="col-md-6">
                                    <div class="group-input">
                                        ...
                                        <select id="select-state" placeholder="Select..." name="qa_assign_person"
                                            ...
                                            <option value="">-- Select a value --</option>
                                            @foreach ($users as $key => $value)
                                                <option @if ($ooc->qa_assign_person == $value->id) selected @endif
                                                    value="{{ $value->id }}">{{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        $('#IncidentAdd').click(function(e) {
                                            function generateTableRow(serialNumber) {
                                                var html =
                                                    ...
                                                    '<td><input type="text" {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} || {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }}  name="instrumentdetails[' +
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="qaheadremarks" placeholder="Enter review"
                                            ...
                                            {{ $ooc->stage == 3 ? 'required' : '' }} {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                            {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }}>{{ $ooc->qaheadremarks }}</textarea>
                            ...
                            <div class="row">
                                                    ...
                                                    @foreach ($oocevaluations as $index => $item)
                                                        @if (isset($oocEvolution->data[$index]))
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <textarea {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                                                        {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }}
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="qa_comments_ooc" class="form-control {{ $errors->has('qa_comments_ooc') ? 'is-invalid' : '' }}"
                                            ...
                                            {{ in_array($ooc->stage, [0, 9, 14]) ? 'disabled' : '' }} {{-- Disable for stages 0, 9, and 14 --}}>{{ $ooc->qa_comments_ooc }}</textarea>
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="qa_comments">Description of Cause for OOC Results (If
                                            Identified)</label>
                                        <textarea name="qa_comments_description_ooc" {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <select id="assignableSelect" name="is_repeat_assingable_ooc"
                                            ...
                                            {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }}>
                                            <option value="NA"
                                                {{ $ooc->is_repeat_assingable_ooc == 'NA' ? 'selected' : '' }}>-- Select
                                                --</option>
                                            <option value="YES"
                                ...
                                <div class="col-lg-12" id="rootCauseGroup" style="display: none;">
                                    <div class="group-input">
                                        ...
                                        <textarea name="rootcausenewfield" id="rootCauseTextarea" rows="4"
                                            placeholder="Describe the root cause here" {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                ...
                                <div class="inner-block-content">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="group-input">
                                                <label for="Initial Attachment">Phase IA Attachement</label>
                                                <div><small class="text-primary">Please Attach all relevant or supporting
                                                        documents</small></div>
                                                {{-- <input type="file" id="myfile" name="Initial_Attachment" {{ $data->stage == 0 || $data->stage == 8 ? "disabled" : "" }}
                                    value="{{ $data->Initial_Attachment }}"> --}}
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <div class="group-input">
                                                <label for="Corrective & Preventive Action">Corrective & Preventive
                                                    Action</label>
                                                <div><small class="text-primary">Please insert "NA" in the data field if it
                                                        does not require completion</small></div>
                                                <textarea class="summernote" {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="group-input">
                                        ...
                                        <div><small class="text-primary">Please insert "NA" in the data field if it does
                                                not require completion</small></div>
                                        <textarea name="phase_IA_HODREMARKS" {{ $ooc->stage == 5 ? 'required' : '' }}
                                            {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                            {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }}>{{ $ooc->phase_IA_HODREMARKS }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="qaremarksnewfield" placeholder="Enter review"
                                            ...
                                            {{ $ooc->stage == 7 ? 'required' : '' }} {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                ...
                                <div class="col-lg-12">
                                    <div class="group-input">
                                        ...
                                        <textarea name="qaHremarksnewfield" placeholder="Enter review"
                                            ...
                                            {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                            {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }}>{{ $ooc->qaHremarksnewfield }}</textarea>
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <select name="is_repeat_stage_instrument_ooc"
                                ...
                                {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }} onchange="">
                                <option value=" "
                                   {{-- {{ $ooc->is_repeat_stage_instrument_ooc == 'NA' ? 'selected' : '' }} --}} >-- Select --
                                </option>
                                <option value="Yes"
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <select name="details_of_instrument_out_of_order" onchange="">
                                <option value=" ">-- select --</option>
                                <option value="Yes" {{ $ooc->details_of_instrument_out_of_order == 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No" {{ $ooc->details_of_instrument_out_of_order == 'No' ? 'selected' : '' }}>No</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <textarea name="phase_IB_HODREMARKS"
                                ...
                                {{ $ooc->stage == 11 ? 'required' : '' }}{{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <textarea name="phase_IB_qareviewREMARKS"
                                ...
                                {{ $ooc->stage == 12 ? 'required' : '' }}{{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
        ...
        <!--
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="group-input">
                                    ...
                                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                    <textarea class="summernote" {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                        {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }} name="initiated_through_capa_ooc"
            ...
            <div class="inner-block-content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="group-input">
                            <label for="Initiator Group">Release of Instrument for usage</label>
                            <select name="is_repeat_realease_stageii_ooc"
                                {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }} onchange="">
                                <option value="0"
                                    {{ $ooc->is_repeat_realease_stageii_ooc == '0' ? 'selected' : '' }}>-- Select --
                                </option>
                                <option value="Yes"
                                    {{ $ooc->is_repeat_realease_stageii_ooc == 'Yes' ? 'selected' : '' }}>Yes</option>
                                <option value="No"
                                    {{ $ooc->is_repeat_realease_stageii_ooc == 'No' ? 'selected' : '' }}>No</option>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="summernote" {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }} name="initiated_through_hodreview_ooc"
                    ...
                    <div class="col-lg-12">
                        <div class="group-input">
                            ...
                            <div class="file-attachment-field">
                                ...
                                <div class="add-btn">
                                    <div>Add</div>
                                    <input {{ $ooc->stage == 0 || $ooc->stage == 14 ? '  ' : '' }} type="file"
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="summernote" {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }} name="initiated_through_rootcause_ooc"
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="summernote" {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }} name="initiated_through_impact_closure_ooc"
                        ...
                        <div class="group-input">
                            <label for="Short Description">Closure Comments
                                <input id="docname" type="text"
                                    {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                    {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }}
                                    name="short_description_closure_ooc"
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <textarea class="summernote" name="initiated_through_closure_ooc" id="summernote-1"
                                {{ $ooc->stage == 0 || $ooc->stage == 9 ? 'disabled' : '' }} ||
                                {{ $ooc->stage == 0 || $ooc->stage == 14 ? 'disabled' : '' }}>{{ $ooc->initiated_through_closure_ooc }}</textarea>
                        </div>
                    </div>
