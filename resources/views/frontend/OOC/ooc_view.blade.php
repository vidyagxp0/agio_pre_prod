...
<div id="change-control-fields">
            ...
            <div class="container-fluid">
                <div class="inner-block state-block">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex" style="gap:20px;">
                            @php
                            $userRoles = DB::table('user_roles')->where(['user_id' => Auth::user()->id,
                            'q_m_s_divisions_id' => $ooc->division_id])->get();
                ...
                class="new-doc-btn">Print</button> --}}
                    ...
                    Cancellation Request
                            ...
                            @elseif($ooc->stage == 3 && (in_array(10, $userRoleIds) || in_array(18, $userRoleIds)))
                            <button class="button_theme1" name="assignable_cause_identification" data-bs-toggle="modal"
                                data-bs-target="#signature-modal">
                                Assignable Cause Found
                            </button>
                            <button class="button_theme1" name="no_assignable_cause_identification"
                                data-bs-toggle="modal" data-bs-target="#signature-modal1">
                            ...
                            @elseif($ooc->stage == 4 && (in_array(7, $userRoleIds) || in_array(18, $userRoleIds)))
                    ...
                    All Activities Completed
                            ...
                            @elseif($ooc->stage == 5 && (in_array(10, $userRoleIds) || in_array(18, $userRoleIds)))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                            ...
                            @elseif($ooc->stage == 6 && (in_array(7, $userRoleIds) || in_array(18, $userRoleIds)))

                            @elseif($ooc->stage == 7 && (in_array(10, $userRoleIds) || in_array(18, $userRoleIds) ||
                            in_array(7, $userRoleIds)))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                            ...
                            @elseif($ooc->stage == 8 && (in_array(7, $userRoleIds) || in_array(18, $userRoleIds) ||
                            in_array(7, $userRoleIds)))
                            ...
                            @elseif($ooc->stage == 9 && (in_array(9, $userRoleIds) || in_array(18, $userRoleIds) ||
                            in_array(7, $userRoleIds)))


                            @elseif($ooc->stage == 10 && (in_array(7, $userRoleIds) || in_array(18, $userRoleIds) ||
                            in_array(7, $userRoleIds)))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Correction Complete
                            </button>
                            ...
                            @elseif($ooc->stage == 11 && (in_array(9, $userRoleIds) || in_array(18, $userRoleIds) ||
                            in_array(7, $userRoleIds)))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal1">
                                QA Review Complete
                            </button>
                            ...
                            @elseif($ooc->stage == 12 && (in_array(9, $userRoleIds) || in_array(18, $userRoleIds) ||
                            in_array(7, $userRoleIds)))
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#rejection-modal">
        ...
        <form action="{{route('OutOfCalibrationUpdate' ,$ooc->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div id="step-form">
                ...
                <div id="CCForm1" class="inner-block cctabcontent">
                    ...
                    <input type="date" name="due_date" {{ $ooc->stage == 0 || $ooc->stage == 8 ? 'disabled' : ''}}
    ...
    <div class="col-md-6 new-date-data-field">
        <div class="group-input input-date">
            ...
            <p class="text-primary">Last date this record should be closed by</p>
            <div class="calenderauditee">
                <input type="text" id="due_date" name="due_date" value="{{ $ooc->due_date->format('d-M-Y') }}"
                    readonly />
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="group-input">
            ...
            <select name="Initiator_Group" {{ $ooc->stage == 0 || $ooc->stage == 8 ? "disabled" : "" }}
                id="initiator_group">
                <option value="NA" @if ($ooc->Initiator_Group== 'NA') selected @endif>Select Department</option>
                <option value="CQA" @if ($ooc->Initiator_Group== 'CQA') selected @endif>Corporate Quality Assurance
                </option>
                <option value="QA" @if ($ooc->Initiator_Group== 'QA') selected @endif>Quality Assurance</option>
                <option value="QC" @if ($ooc->Initiator_Group== 'QC') selected @endif>Quality Control</option>
                <option value="QM" @if ($ooc->Initiator_Group== 'QM') selected @endif>Quality Control (Microbiology
                    department)</option>
                <option value="PG" @if ($ooc->Initiator_Group== 'PG') selected @endif>Production General</option>
                <option value="PL" @if ($ooc->Initiator_Group== 'PL') selected @endif>Production Liquid Orals</option>
                <option value="PT" @if ($ooc->Initiator_Group== 'PT') selected @endif>Production Tablet and Powder
                </option>
                <option value="PE" @if ($ooc->Initiator_Group== 'PE') selected @endif>Production External (Ointment,
                    Gels, Creams and Liquid)</option>
                <option value="PC" @if ($ooc->Initiator_Group== 'PC') selected @endif>Production Capsules</option>
                <option value="PI" @if ($ooc->Initiator_Group== 'PI') selected @endif>Production Injectable</option>
                <option value="EN" @if ($ooc->Initiator_Group== 'EN') selected @endif>Engineering</option>
                <option value="HR" @if ($ooc->Initiator_Group== 'HR') selected @endif>Human Resource</option>
                <option value="ST" @if ($ooc->Initiator_Group== 'ST') selected @endif>Store</option>
                <option value="IT" @if ($ooc->Initiator_Group== 'IT') selected @endif>Electronic Data Processing
                </option>
                <option value="FD" @if ($ooc->Initiator_Group== 'FD') selected @endif>Formulation Development</option>
                <option value="AL" @if ($ooc->Initiator_Group== 'AL') selected @endif>Analytical research and
                    Development Laboratory</option>
                <option value="PD" @if ($ooc->Initiator_Group== 'PD') selected @endif>Packaging Development</option>
                <option value="PU" @if ($ooc->Initiator_Group== 'PU') selected @endif>Purchase Department</option>
                <option value="DC" @if ($ooc->Initiator_Group== 'DC') selected @endif>Document Cell</option>
                <option value="RA" @if ($ooc->Initiator_Group== 'RA') selected @endif>Regulatory Affairs</option>
                <option value="PV" @if ($ooc->Initiator_Group== 'PV') selected @endif>Pharmacovigilance</option>
            </select>
        </div>
    </div>
    ...
    <div class="col-md-6 new-date-data-field">
        <div class="group-input input-date">
            ...
            <div class="calenderauditee">
                <input type="text" id="date_of_out_of_calibration_display" readonly placeholder="DD-MMM-YYYY"
                    value="{{ $ooc->date_of_out_of_calibration ? \Carbon\Carbon::parse($ooc->date_of_out_of_calibration)->format('d-M-Y') : '' }}">
                <input type="date" name="date_of_out_of_calibration" class="hide-input" id="date_of_out_of_calibration"
                    oninput="handleDateInput(this, 'date_of_out_of_calibration_display')"
                    value="{{ $ooc->date_of_out_of_calibration }}">
        ...
        <div class="group-input input-date">
            ...
            <div class="calenderauditee">
                <input type="text" id="date_of_discovery_display" readonly placeholder="DD-MMM-YYYY"
                    value="{{ $ooc->date_of_discovery ? \Carbon\Carbon::parse($ooc->date_of_discovery)->format('d-M-Y') : '' }}">
                <input type="date" name="date_of_discovery" class="hide-input" id="date_of_discovery"
                    oninput="handleDateInput(this, 'date_of_discovery_display')" value="{{ $ooc->date_of_discovery }}">
    ...
    <div class="col-md-6 new-date-data-field">
        <div class="group-input input-date">
            ...
            <div class="calenderauditee">
                <input type="text" id="last_calibration_date_display" readonly placeholder="DD-MMM-YYYY"
                    value="{{ $ooc->last_calibration_date ? \Carbon\Carbon::parse($ooc->last_calibration_date)->format('d-M-Y') : '' }}">
                <input type="date" name="last_calibration_date" class="hide-input" id="last_calibration_date"
                    oninput="handleDateInput(this, 'last_calibration_date_display')"
                    value="{{ $ooc->last_calibration_date }}">
    ...
    <div class="col-md-6">
        <div class="group-input">
            ...
            <select name="calibration_frequency" class="calibrationfrequency" id="calibration_frequency">
                <option value="monthly"
                    {{ old('calibration_frequency', $ooc->calibration_frequency) == 'monthly' ? 'selected' : '' }}>
                    Monthly
                </option>
                <option value="quarterly"
                    {{ old('calibration_frequency', $ooc->calibration_frequency) == 'quarterly' ? 'selected' : '' }}>
                    Quarterly
                </option>
                <option value="yearly"
                    {{ old('calibration_frequency', $ooc->calibration_frequency) == 'yearly' ? 'selected' : '' }}>Yearly
                </option>
            </select>
...
<div class="col-lg-12">
    <div class="group-input">
        ...
        <input type="text" name="initiator_group_code" id="initiator_group_code" value="{{$ooc->Initiator_Group}}"
            readonly>
    </div>
</div>
...
<div class="col-md-12 mb-3">
    <div class="group-input">
        ...
        <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small>
        </div>
...
<div class="col-lg-12">
    <div class="group-input">
        ...
        <select id="initiator_group" name="is_repeat_ooc">
            <option value="" {{ $ooc->is_repeat_ooc == '0' ? 'selected' : '' }}>-- Select --</option>
...
<div class="col-lg-12">
    <div class="group-input">
        ...
        <div class="file-attachment-field">
            ...
            <div class="add-btn">
                <div>Add</div>
                <input {{ $ooc->stage == 0 || $ooc->stage == 8 ? "disabled" : "" }} type="file"
                    id="initial_attachment_ooc" name="initial_attachment_ooc[]"
...
<div class="col-md-6">
    <div class="group-input">
        ...
        <select id="select-state" placeholder="Select..." name="assign_to"
            ...
            <option @if ($ooc->assign_to == $value->id) selected @endif value="{{ $value->id }}">{{ $value->name }}
            </option>
            @endforeach
        </select>
        @error('assign_to')
...
{{-- <div class="col-lg-6 new-date-data-field">
                                <div class="group-input input-date">
                                    <label for="Date Due"> OOC Discovered On </label>
...
{{ $ooc->stage == 0 || $ooc->stage == 8 ? 'disabled' : ''}}/>
<input type="date" name="ooc_due_date" {{ $ooc->stage == 0 || $ooc->stage == 8 ? 'disabled' : ''}}
    min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" class="hide-input"
...
<div class="col-md-6 new-date-data-field">
    <div class="group-input input-date">
        ...
        <div class="calenderauditee">
            <input type="text" id="ooc_due_date_display" readonly placeholder="DD-MMM-YYYY"
                value="{{ Helpers::getdateFormat($ooc->ooc_due_date) }}" />
            <input type="date" id="ooc_due_date" name="ooc_due_date" class="hide-input" value="{{ $ooc->ooc_due_date }}"
        ...
        <table class="table table-bordered" id="onservation-incident-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" name="instrumentdetails[{{$loop->index}}][instrument_name]"
                            value="{{$oogrid['instrument_name']}}"></td>
                    <td><input type="text" name="instrumentdetails[{{$loop->index}}][instrument_id]"
                            value="{{$oogrid['instrument_id']}}"></td>
                    <td><input type="text" name="instrumentdetails[{{$loop->index}}][remarks]"
                            value="{{$oogrid['remarks']}}"></td>
                    <td><input type="text" name="instrumentdetails[{{$loop->index}}][calibration]"
                            value="{{$oogrid['calibration']}}"></td>
                    <td><input type="text" name="instrumentdetails[{{$loop->index}}][acceptancecriteria]"
                            value="{{$oogrid['acceptancecriteria']}}"></td>
                    <td><input type="text" name="instrumentdetails[{{$loop->index}}][results]"
                            value="{{$oogrid['results']}}"></td>
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <textarea class="summernote" name="supervisor_review"
                        id="summernote-1">{{ old('supervisor_review', $ooc->supervisor_review) }}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    <label for="section_incharge_review">Section Incharge</label>
                    <textarea class="summernote" name="section_incharge_review"
                        id="summernote-1">{{ old('section_incharge_review', $ooc->section_incharge_review) }}</textarea>
                </div>
            </div>
                ...
                <div class="group-input">
                    ...
                    <div class="file-attachment-field">
                        ...
                        <div class="add-btn">
                            <div>Add</div>
                            <input {{ $ooc->stage == 0 || $ooc->stage == 8 ? "disabled" : "" }} type="file"
                                id="attachments_hod_ooc" name="attachments_hod_ooc[]"
...
<div id="CCForm3" class="inner-block cctabcontent">
    <div class="inner-block-content">
        <div class="row">
            ...
            <!-- <div class="col-lg-12">
                <div class="group-input">
                    ...
                    <select id="initiator_group" name="is_repeat_assingable_ooc">
                        <option value="NA" {{ $ooc->is_repeat_assingable_ooc == 'NA' ? 'selected' : '' }}>-- Select --
                        </option>
            ...
            <div class="col-lg-12">
                <div class="group-input">
                    <label for="is_repeat_assingablerc_ooc">Assignable root cause found</label>
                    <textarea
                        name="is_repeat_assingablerc_ooc">{{ old('is_repeat_assingablerc_ooc', $ooc->is_repeat_assingablerc_ooc) }}</textarea>
                </div>
            </div>

            <div class="col-lg-12">
                <div class="group-input">
                    <label for="is_repeat_assingable_ooc">Non Assignable root cause found</label>
                    <textarea
                        name="is_repeat_assingable_ooc">{{ old('is_repeat_assingable_ooc', $ooc->is_repeat_assingable_ooc) }}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <textarea class="summernote" name="justification_for_protocol_study_hypothesis_study_ooc"
                        id="summernote-1">{{$ooc->justification_for_protocol_study_hypothesis_study_ooc}}
                                    </textarea>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="analysis_remarks_stage_ooc"
                        id="summernote-1">{{$ooc->analysis_remarks_stage_ooc}}  </textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="calibration_results_stage_ooc"
                        id="summernote-1">{{$ooc->calibration_results_stage_ooc}}</textarea>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="group-input">
                    ...
                    <select name="is_repeat_result_naturey_ooc" onchange="">
                        <option value="0" {{ $ooc->is_repeat_result_naturey_ooc == '0' ? 'selected' : '' }}>-- Select --
                        </option>
                        <option value="Yes" {{ $ooc->is_repeat_result_naturey_ooc == 'Yes' ? 'selected' : '' }}>Yes
                        </option>
                        <option value="No" {{ $ooc->is_repeat_result_naturey_ooc == 'No' ? 'selected' : '' }}>No
                        </option>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="review_of_calibration_results_of_analyst_ooc"
                        id="summernote-1">{{$ooc->review_of_calibration_results_of_analyst_ooc}}</textarea>
                </div>
            </div>
                ...
                <div class="group-input">
                    ...
                    <div class="file-attachment-field">
                        ...
                        <div class="add-btn">
                            <div>Add</div>
                            <input {{ $ooc->stage == 0 || $ooc->stage == 8 ? "disabled" : "" }} type="file"
                                id="attachments_stage_ooc" name="attachments_stage_ooc[]"
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="results_criteria_stage_ooc"
                        id="summernote-1">{{$ooc->results_criteria_stage_ooc}}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <select name="ooc_category" id="ooc_category">
                        <option value="" {{ $ooc->ooc_category == '' ? 'selected' : '' }}>-- Select --</option>
                        <option value="Validated" {{ $ooc->ooc_category == 'Validated' ? 'selected' : '' }}>Validated
                        </option>
                        <option value="Invalidated" {{ $ooc->ooc_category == 'Invalidated' ? 'selected' : '' }}>
                            Invalidated</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="additional_remarks_stage_ooc"
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="stagei_hypthesis_study_ooc" id="summernote-1">{{$ooc->stagei_hypthesis_study_ooc}}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="justification_for_protocol_study_stageI_ooc" id="summernote-1">{{$ooc->justification_for_protocol_study_stageI_ooc}}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <textarea class="summernote" name="plan_of_protocol_stageI_study_hypothesis_study"
                        id="summernote-1">{{$ooc->plan_of_protocol_stageI_study_hypothesis_study}}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <textarea class="summernote" name="conclusion_of_protocol_stageI_based_study_hypothesis_study_ooc"
                        id="summernote-1">{{ $ooc->conclusion_of_protocol_stageI_based_study_hypothesis_study_ooc }}</textarea>
                </div>
            </div>
    ...
    <div class="inner-block-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="group-input">
                    ...
                    <select name="is_repeat_stageii_ooc" onchange="">
                        <option value="NA" {{ $ooc->is_repeat_stageii_ooc == 'NA' ? 'selected' : '' }}>-- Select --
                        </option>
            ...
            <div id="InstrumentOutofOrder" class="group-input col-6" style="display: none;">
                ...
                <input type="text" name="otherFieldsUser_action" class="form-control"  value ="{{$ooc->actiontaken_action}}"/>
            </div>
            <div id="AttachmentField" class="col-lg-12" style="display: none;">
                <div class="group-input">
                    <label for="Initial Attachment">Attachment For Service Engineer Report</label>
                    <div><small class="text-primary">Please Attach all relevant or supporting documents</small></div>
                    <div class="file-attachment-field">
                        <div class="file-attachment-list" id="Initial_Attachment_otherfield">
                            @if ($ooc->Initial_Attachment_otherfield)
                            @foreach (json_decode($ooc->Initial_Attachment_otherfield) as $file)
                            <h6 type="button" class="file-container text-dark"
                                style="background-color: rgb(243, 242, 240);">
                                <b>{{ $file }}</b>
                                <a href="{{ asset('upload/' . $file) }}" target="_blank"><i
                        ...
                        <div class="add-btn">
                            <div>Add</div>
                            <input {{ $ooc->stage == 0 || $ooc->stage == 8 ? "disabled" : "" }} type="file"
                                id="Initial_Attachment_otherfield" name="Initial_Attachment_otherfield[]"
            ...
            <!-- <div class="col-lg-12">
                <div class="group-input">
                    ...
                    <select name="is_repeat_proposed_stage_ooc" onchange="">
                        <option value="0" {{ $ooc->is_repeat_proposed_stage_ooc == '0' ? 'selected' : '' }}>-- Select --
                        </option>
                        <option value="Yes" {{ $ooc->is_repeat_proposed_stage_ooc == 'Yes' ? 'selected' : '' }}>Yes
                        </option>
                        <option value="No" {{ $ooc->is_repeat_proposed_stage_ooc == 'No' ? 'selected' : '' }}>No
                        </option>
            ...
            <div class="col-lg-12">
                <div class="group-input">
                    ...
                    <input type="text" name="is_repeat_proposed_stage_ooc"
                        value="{{$ooc->is_repeat_proposed_stage_ooc}}">
            ...
            <input type="text" name="User_compiled" class="form-control" readonly value="{{ $ooc->User_compiled }}" />
        </div>
            ...
            <div class="col-lg-6">
                <div class="group-input">
                    ...
                    <select name="is_repeat_realease_stageii_ooc" onchange="">
                        <option value="0" {{ $ooc->is_repeat_realease_stageii_ooc == '0' ? 'selected' : '' }}>-- Select
                            --</option>
                        <option value="Yes" {{ $ooc->is_repeat_realease_stageii_ooc == 'Yes' ? 'selected' : '' }}>Yes
                        </option>
                        <option value="No" {{ $ooc->is_repeat_realease_stageii_ooc == 'No' ? 'selected' : '' }}>No
                        </option>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_throug_stageii_ooc"
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_through_stageii_ooc"
            ...
            <div class="col-lg-12">
                <div class="group-input">
                    ...
                    <select name="is_repeat_reanalysis_stageii_ooc" onchange="">
                        <option value="0" {{ $ooc->is_repeat_reanalysis_stageii_ooc == '0' ? 'selected' : '' }}>--
                            Select --</option>
                        <option value="Yes" {{ $ooc->is_repeat_reanalysis_stageii_ooc == 'Yes' ? 'selected' : '' }}>Yes
                        </option>
                        <option value="No" {{ $ooc->is_repeat_reanalysis_stageii_ooc == 'No' ? 'selected' : '' }}>No
                        </option>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_through_stageii_cause_failure_ooc"
            ...
            <div class="group-input">
                ...
                <textarea name="re_qualification_status" id="re_qualification_status" class="form-control">{{ $ooc->re_qualification_status }}</textarea>
            </div>
        </div>
            ...
            <div class="group-input">
                ...
                <textarea name="calibration_status" id="calibration_status" class="form-control" >{{ $ooc->calibration_status }}</textarea>
            </div>
        </div>
            ...
            <div class="group-input">
                ...
                <select name="found_satisfactory" id="found_satisfactory" class="form-control" disabled>
                    <option value="1" {{ $ooc->found_satisfactory == '1' ? 'selected' : '' }}>Yes</option>
                    <option value="0" {{ $ooc->found_satisfactory == '0' ? 'selected' : '' }}>No</option>
                </select>
            </div>
        </div>
            <div class="col-md-6">
            ...
            <div id="typeOfErrorBlock" class="group-input col-6" style="display: none;">
                ...
                <input type="text" name="otherFieldsUser" class="form-control" value ="{{$ooc->OthewrReviewed_ooc}}"/>
            </div>
            ...
            <div class="group-input">
                    ...
                    <div><small class="text-primary">Please Attach all relevant or supporting documents</small></div>
                    <div class="file-attachment-field">
                        <div class="file-attachment-list" id="service_engineer_report_attachment">
                            @if ($ooc->service_engineer_report_attachment)
                            @foreach (json_decode($ooc->service_engineer_report_attachment) as $file)
                            <h6 type="button" class="file-container text-dark"
                                style="background-color: rgb(243, 242, 240);">
                                <b>{{ $file }}</b>
                                <a href="{{ asset('upload/' . $file) }}" target="_blank"><i
                        ...
                        <div class="add-btn">
                            <div>Add</div>
                            <input {{ $ooc->stage == 0 || $ooc->stage == 8 ? "disabled" : "" }} type="file"
                                id="service_engineer_report_attachment" name="service_engineer_report_attachment[]"
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="group-input">
                    ...
                    <select name="is_repeat_capas_ooc" id="is_repeat_capas_ooc">
                        <option value="0" {{ $ooc->is_repeat_capas_ooc == '0' ? 'selected' : '' }}>-- Select --</option>
                        <option value="Corrective Action"
                            {{ $ooc->is_repeat_capas_ooc == 'Corrective Action' ? 'selected' : '' }}>Corrective Action
                        </option>
                        <option value="Preventive Action"
                            {{ $ooc->is_repeat_capas_ooc == 'Preventive Action' ? 'selected' : '' }}>Preventive Action
                        </option>
                        <option value="Correction" {{ $ooc->is_repeat_capas_ooc == 'Correction' ? 'selected' : '' }}>
                            Correction</option>
                        <option value="Preventive Measure"
                            {{ $ooc->is_repeat_capas_ooc == 'Preventive Measure' ? 'selected' : '' }}>Preventive Measure
                        </option>
                    </select>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_through_capas_ooc"
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_through_capa_prevent_ooc"
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_through_capa_corrective_ooc"
                ...
                <div class="group-input">
                    ...
                    <div class="file-attachment-field">
                        ...
                        <div class="add-btn">
                            <div>Add</div>
                            <input {{ $ooc->stage == 0 || $ooc->stage == 8 ? "disabled" : "" }} type="file"
                                id="initial_attachment_capa_ooc" name="initial_attachment_capa_ooc[]"
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_through_capa_ooc"
                        id="summernote-1">{{$ooc->initiated_through_capa_ooc}}</textarea>
                </div>
            </div>
                ...
                <div class="group-input">
                    ...
                    <div class="file-attachment-field">
                        ...
                        <div class="add-btn">
                            <div>Add</div>
                            <input {{ $ooc->stage == 0 || $ooc->stage == 8 ? "disabled" : "" }} type="file"
                                id="initial_attachment_capa_post_ooc" name="initial_attachment_capa_post_ooc[]"
        ...
        <div class="row">
                ...
                <div class="group-input">
                    <label for="Short Description">Closure Comments
                        <input id="docname" type="text" name="short_description_closure_ooc"
                            value="{{$ooc->short_description_closure_ooc}}">
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="group-input">
                    ...
                    <div class="file-attachment-field">
                        ...
                        <div class="add-btn">
                            <div>Add</div>
                            <input type="file" id="initial_attachment_closure_ooc"
                                name="initial_attachment_closure_ooc[]"
                ...
                <div class="group-input">
                    <label for="Short Description">Document Code
                        <input id="docname" type="text" name="document_code_closure_ooc"
                            value="{{$ooc->document_code_closure_ooc}}">
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_through_closure_ooc"
                        id="summernote-1">{{$ooc->initiated_through_closure_ooc}}</textarea>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_through_hodreview_ooc"
                        id="summernote-1">{{$ooc->initiated_through_hodreview_ooc}}</textarea>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="group-input">
                    ...
                    <div class="file-attachment-field">
                        ...
                        <div class="add-btn">
                            <div>Add</div>
                            <input {{ $ooc->stage == 0 || $ooc->stage == 8 ? "  " : "" }} type="file"
                                id="initial_attachment_hodreview_ooc" name="initial_attachment_hodreview_ooc[]"
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                            completion</small></div>
                    <textarea class="summernote" name="initiated_through_rootcause_ooc"
                        id="summernote-1">{{$ooc->initiated_through_rootcause_ooc}}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    ...
                    <textarea class="summernote" name="initiated_through_impact_closure_ooc"
                        id="summernote-1">{{$ooc->initiated_through_impact_closure_ooc}}</textarea>
                </div>
            </div>
            <div class="col-md-12 mb-3">
                <div class="group-input">
                    <label for="sample_status">Reanalysis Result</label>
                    <select name="sample_status" id="sample_status">
                        <option value="0" {{ $ooc->sample_status == '0' ? 'selected' : '' }}>-- Select --</option>
                        <option value="Passed" {{ $ooc->sample_status == 'Passed' ? 'selected' : '' }}>Sample Passed
                        </option>
                        <option value="Failed" {{ $ooc->sample_status == 'Failed' ? 'selected' : '' }}>Sample Failed
                        </option>
                    </select>
                </div>
            </div>
...
<div id="CCForm9" class="inner-block cctabcontent">
    <div class="inner-block-content">
        ...
        <div class="row">
            ...
            <center>
                <div class="sub-head" style="width:10%">
                    Activity Log
                </div>
            </center>
            ...
            <div class="col-lg-4 new-date-data-field">
                <div class="group-input input-date">
                    <label for="hod_review_occ_comment">Required By : </label>
                    <div class="static"></div>
                </div>
            </div>
            <div class="col-lg-4 new-date-data-field">
                <div class="group-input input-date">
                    <label for="hod_review_occ_comment">Required On : </label>
                    <div class="static"></div>
                </div>
            </div>
            <div class="col-lg-4 new-date-data-field">
                <div class="group-input input-date">
                    <label for="hod_review_occ_comment">Required Comment : </label>
                    <div class="static"></div>
                </div>
            </div>
