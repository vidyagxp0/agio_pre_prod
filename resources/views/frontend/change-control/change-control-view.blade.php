            ...
            <div class="inner-block state-block">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        ...
                        <button class="button_theme1"> <a class="text-white" href="{{ url('change-control-audit', $data->id) }}"> Audit Trail </a> </button>
                        @if ($data->stage == 1)
                        ...
                        @elseif($data->stage == 3)
                            <button class="button_theme1" data-bs-toggle="modal" data-bs-target="#signature-modal">
                                Send to CFT Reviewer
                            </button>
                        @elseif($data->stage == 5)
                        @if($data->document_required == 'yes')

                          <button class="button_theme1" id="set-division">
                              Create Document
                          </button>
                ...
                <div class="status">
                    ...
                    <div class="progress-bars">
                        ...
                        @endif
                        @if ($data->stage >= 3)
                            <div class="active">HOD Review Completed</div>
                        @else
                            <div class="">HOD Review Completed</div>
                        @endif
                        @if ($data->stage >= 4)
                            <div class="active">Under CFT Review</div>
                        @else
                            <div class="">Under CFT Review</div>
                        @endif
                        @if ($data->stage >= 5)
                                            ...
                                            <div class="group-input input-date">
                                                ...
                                                <!-- <input type="date" name="due_date" id="Changedue_date"
                                                    ...
                                                    <div class="calenderauditee">                                     
                                                        <input type="text"  id="Changedue_date"   value="{{ $openStage->due_date }}"  readonly placeholder="DD-MMM-YYYY" />
                    ...
                    <div class="modal-body">
                        ...
                        <div class="group-input">
                            ...
                            <select name="electronic-meaning">
                                ...
                                <option value="assure-approved">Send Document for Review</option>
                            </select>
                        </div>
                        <div class="group-input">
