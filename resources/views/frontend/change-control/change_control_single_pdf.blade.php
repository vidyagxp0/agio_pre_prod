                ...
                <div class="head">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <div><strong>On {{ Helpers::getDateFormat($evaluation->qa_evaluation_attachments) }}
                                        added by {{ $data->qa_evaluation_attachments }}</strong>
                                </div>
                                <div>
        ...
        <div class="block">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="w-30">
                        <div class="static">{{ $data->QA_head_approval_comment }}</div>
                    </td>
                </tr>
            </table>
        </div>
