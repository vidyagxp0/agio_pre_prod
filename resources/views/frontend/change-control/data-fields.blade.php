...
@section('container')
    ...
    {{-- ======================================
                    DATA FIELDS
    ======================================= --}}
    <div id="change-control-fields" style="min-height:100vh;">
        <div class="container-fluid">
            ...
            <form id="myForm" action="{{ route('change-control.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Tab content -->
                <div id="step-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="group-input">
                                        ...
                                        <input type="text" name="title" value="{{ old('title') }}" id="ChangeTitle">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="group-input">
                                        ...
                                        <input list="batches" name="batch" value="{{ old('batch') }}">
                                        <datalist id="batches">
                                            <option value="0">-- Select --</option>
                                ...
                                <div class="col-md-6 new-date-data-field">
                                    <div class="group-input input-date">
                                        ...
                                        <div class="calenderauditee">                                     
                                            <input type="text"  id="Changedue_date" value="{{ old('due_date') }}" readonly placeholder="DD-MMM-YYYY" />
                                        ...
                                        <select name="assign_to" id="assign_to">
                                            @foreach ($user as $temp)
                                                <option value="{{ $temp->id }}"
                                                    @if (old('assign_to') == $temp->id) selected @endif>
                                                    {{ $temp->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="group-input">
                                        ...
                                        <select multiple name="cft[]" placeholder="Select CFT Reviewers"
                                            ...
                                            @foreach ($user as $temp)
                                                <option value="{{ $temp->id }}"
                                                    @if (old('cft') == $temp->id) selected @endif>{{ $temp->name }}
                                                </option>
                                            @endforeach
                                        </select>
