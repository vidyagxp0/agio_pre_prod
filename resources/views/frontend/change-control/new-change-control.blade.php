...
<script>
        ...
        <div class="container-fluid">
            <div class="inner-block">
                ...
                <div class="slogan">
                    ...
                    {{ Helpers::getDivisionName(!empty($parent_division_id) ? $parent_division_id : session()->get('division')) }} / Change Control
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="change-control-fields">
        <div class="container-fluid">
            ...
            <form class="formSubmit" action="{{ route('CC.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Tab content -->
                <div id="step-form">
                    ...
                    <div id="CCForm4" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-12">
                                    <div class="group-input">
                                        <label for="qa_comments">QA/CQA Initial Review Comments</label>
                    ...
                    <div id="CCForm10" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            ...
                            <div class="group-input">
                                <label for="qa-closure-comments">QA/CQA Closure Comments</label>
