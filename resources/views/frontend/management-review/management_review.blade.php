                            ...
                            <div class="group-input">
                                <label for="action_item_details">
                                    Action Item Details<button type="button" name="action_item_details"
                                        onclick="addActionItemDetails('action_item_details')" id="action_item">+</button>
                                </label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="group-input new-date-data-field mb-0">
                                                        <div class="input-date ">
                                                            <div class="calenderauditee">
                                                                <input type="text" id="date_due{{ $key }}"
                                                                    readonly placeholder="DD-MMM-YYYY"
                                                                ...
                                                                <input type="date"
                                                                    ...
                                                                    value="{{ Helpers::getdateFormat(unserialize($action_item_details->date_due)[$key]) }}
                                                                        "class="hide-input"
                                                                    oninput="handleDateInput(this, `date_due{{ $key }}`);checkDate('date_due{{ $key }}_checkdate','date_closed{{ $key }}_checkdate')" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td> <select id="select-state" placeholder="Select..."
                                                        ...
                                                        @foreach ($users as $undata)
                                                            <option
                                                                {{ unserialize($action_item_details->responsible_person)[$key] ?? null ? (unserialize($action_item_details->responsible_person)[$key] == $undata->id ? 'selected' : ' ') : '' }}
                                                                value="{{ $undata->id }}">
                                                                {{ $undata->name }}
                                                            </option>
                                                        @endforeach
                                                        ...
                                                        <div class="input-date ">
                                                            <div class="calenderauditee">
                                                                ...
                                                                <input type="date"
                                                                    ...
                                                                    name="date_closed[]"
                                                                    min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                    value="{{ Helpers::getdateFormat(unserialize($action_item_details->date_closed)[$key]) }}"class="hide-input"
                                                                    oninput="handleDateInput(this, `date_closed{{ $key }}`);checkDate('date_due{{ $key }}_checkdate','date_closed{{ $key }}_checkdate')" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select id="select-state" placeholder="Select..."
                                                            ...
                                                            <option value="corrective"
                                                                {{ unserialize($capa_detail_details->capa_type)[$key] == 'corrective' ? 'selected' : '' }}>
                                                                Corrective Action</option>
                                                            <option value="preventive"
                                                                {{ unserialize($capa_detail_details->capa_type)[$key] == 'preventive' ? 'selected' : '' }}>
                                                                Preventive Action</option>
                                                            <option value="corrective_preventive"
                                                                {{ unserialize($capa_detail_details->capa_type)[$key] == 'corrective_preventive' ? 'selected' : '' }}>
                                                    ...
                                                    <td>
                                                        <select id="select-state" placeholder="Select..."
                                                            ...
                                                            @foreach ($users as $undata)
                                                                <option
                                                                    {{ unserialize($capa_detail_details->responsible_person2)[$key] ? (unserialize($capa_detail_details->responsible_person2)[$key] == $undata->id ? 'selected' : ' ') : '' }}
                                                                    value="{{ $undata->id }}">
                                                                    {{ $undata->name }}
                                                                </option>
                                                            @endforeach
                                                            ...
                                                            <div class="input-date ">
                                                                <div class="calenderauditee">
                                                                    ...
                                                                    <input type="date"
                                                                        ...
                                                                        name="date_closed2[]"
                                                                        min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                        value="{{ Helpers::getdateFormat(unserialize($capa_detail_details->date_closed2)[$key]) }}"class="hide-input"
                                                                        oninput="handleDateInput(this, `date_closed2{{ $key }}`)" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
