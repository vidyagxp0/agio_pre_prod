...
@section('container')
            ...
            $('#risk-assessment-risk-management').click(function(e) {
                function generateTableRow(serialNumber) {
                    ...
                    var html =
                        ...
                        '<td> <select name="failure_mode_qrms[' + serialNumber + '][initial_detectability]" id="analysisNScript" onchange="calculateRiskAnalysisScript(this)"> <option value="1">-- Select --</option><option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select> </td>' +
    ...
    <!-- Failure Investigation Form Starts -->
    ...
    <div id="change-control-view">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex" style="gap:20px;">
                        @php
                            ...
                            $cftUsers = DB::table('failure_investigation_cfts')
                                ->where(['failure_investigation_id' => $data->id])
                                ->first();
                            ...
                            $cftCompleteUser = DB::table('failure_investigation_cft_responses')
                        ...
                        <button class="button_theme1"> <a class="text-white"
                                href="{{ url('rcms/failure-investigation-audit-trail', $data->id) }}">Audit Trail </a> </button>
        ...
        <div style="background: #e0903230;" id="change-control-fields">
            <div class="container-fluid">
                ...
                <form id="auditForm" action="{{ route('failure-investigation-update', $data->id) }}" method="post"
                            ...
                            <div class="inner-block-content">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 new-date-data-field">
                                        <div class="group-input input-date">
                                            <label for="Short Description required">Repeat Failure Investigation? <span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="group-input">
                                            ...
                                            <label for="If Other">Failure Investigation Observed By<span
                                                    class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="group-input">
                                            ...
                                            <textarea class="tiny"
                                                name="Description_failure_investigation"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }} id="summernote-1">{{ $data->Description_failure_investigation }}</textarea>
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="group-input">
                                            <label for="Preliminary Impact">Preliminary Impact of Failure Investigation <span
                                                    class="text-danger">*</span></label>
                                            <div><small class="text-primary">Please insert "NA" in the data field if it
                                                    does not require completion</small></div>
                        ...
                        <script>
                            ...
                            $(document).ready(function() {
                                $('#failure_investigation_category, #Investigation_required, #qrm_required, #capa_required').change(
                                    function() {
                                        // Get the selected values
                                        var failure_investigationCategory = $('#failure_investigation_category').val();
                                    ...
                                    <div class="row">
                                        ...
                                        <div style="margin-bottom: 0px;" class="col-lg-12 new-date-data-field ">
                                            <div class="group-input input-date">
                                                ...
                                                @if ($data->stage == 3)
                                                    <label for="Failure Investigation category">Failure Investigation category <span
                                                            class="text-danger">*</span></label>
                                                    <select id="failure_investigation_category"
                                                        ...
                                                        <option @if ($data->failure_investigation_category == 'critical') selected @endif
                                                            value="critical">Critical</option>
                                                    </select>
                                                @else
                                                    <label for="Failure Investigation category">Failure Investigation category</label>
                                                    <select id="failure_investigation_category"
                                                        name="failure_investigation_category"{{ $data->stage == 0 || $data->stage == 7 ? 'disabled' : '' }}
                                                ...
                                                @error('failure_investigation_category')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="group-input input-date">
                                        @if ($data->stage == 3)
                                            ...
                                            <select disabled id="failure_investigation_category"
                                                ...
                                                value="{{ $data->failure_investigation_category }}">
                                                <option value="0">-- Select --</option>
                                                <option @if ($data->failure_investigation_category == 'minor') selected @endif value="minor">
                                                    Minor</option>
                                                <option @if ($data->failure_investigation_category == 'major') selected @endif value="major">
                                                    Major</option>
                                                <option @if ($data->failure_investigation_category == 'critical') selected @endif
                                                    value="critical">Critical</option>
                                            </select>
                    ...
                    <div id="CCForm7" class="inner-block cctabcontent">
                        <div class="inner-block-content">
                            <div class="row">
                                ...
                                @php
                                    $data1 = DB::table('failure_investigation_cfts')
                                        ->where('failure_investigation_id', $data->id)
                                        ->first();
                                @endphp
                ...
                <div class="row">
                    ...
                    @else
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label for="Proposed Due Date">Proposed Due Date</label>
                                <input name="investigation_proposed_due_date" id="investigation_proposed_due_date" placeholder="Failure Investigation Proposed Due Date"  disabled>
                            </div>
                        </div>
                    @endif
                    <div class="col-md-12 mb-3">
                ...
                <div class="row">
                                ...
                                <table class="table table-bordered" style="width: 200%"
                                    ...
                                    <tbody>
                                        ...
                                        @if ($grid_data_qrms && is_array($grid_data_qrms->data))
                                            @foreach ($grid_data_qrms->data as $grid_data_qrms)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="numberDetail"
                                                            name="failure_mode_qrms[{{ $loop->index }}][initial_rpn]" id="analysisRPN" value="{{ isset($grid_data_qrms['initial_rpn']) ? $grid_data_qrms['initial_rpn'] : '' }}" readonly>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="numberDetail"
                                                            name="failure_mode_qrms[{{ $loop->index }}][residual_rpn]" id="analysisRPNNew" readonly
                                        ...
                                        @else
                                            ...
                                            <td>
                                                <select name="failure_mode_qrms[0][initial_severity]" id="analysisR" onchange="calculateRiskAnalysis(this)">
                                                    <option value="">-- Select --</option>
                                            ...
                                            <td>
                                                <select name="failure_mode_qrms[0][initial_probability]" id="analysisP" onchange="calculateRiskAnalysis(this)">
                                                    <option value="">-- Select --</option>
                                            ...
                                            <td>
                                                <select name="failure_mode_qrms[0][initial_detectability]" id="analysisN" onchange="calculateRiskAnalysis(this)">
                                                    <option value="">-- Select --</option>
                                            ...
                                            <td><input type="text" class="Document_Remarks" id="analysisRPN" name="failure_mode_qrms[0][initial_rpn]"></td>
                                            ...
                                            <td>
                                                <select name="failure_mode_qrms[0][residual_severity]" id="analysisRNew" onchange="calculateRiskAnalysisNew(this)">
                                                    <option value="">-- Select --</option>
                                            ...
                                            <td>
                                                <select name="failure_mode_qrms[0][residual_probability]" id="analysisPNew" onchange="calculateRiskAnalysisNew(this)">
                                                    <option value="">-- Select --</option>
                                            ...
                                            <td>
                                                <select name="failure_mode_qrms[0][residual_detectability]" id="analysisNNew" onchange="calculateRiskAnalysisNew(this)">
                                                    <option value="">-- Select --</option>
                                            ...
                                            <td><input type="text" class="Document_Remarks" name="failure_mode_qrms[0][residual_rpn]" id="analysisRPNNew"></td>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="text" name="Conclusion" id="Conclusion" value="{{$data->Conclusion}}">{{$data->Conclusion}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="text" name="Identified_Risk" value="{{$data->Identified_Risk}}" id="Identified_Risk">{{$data->Identified_Risk}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <select name="severity_rate" id="analysisR" onchange='calculateRiskAnalysis(this)'>
                                <option value="">Enter Your Selection Here</option>
                                <option value="1" @if ($data->severity_rate == 'negligible') selected @endif>Negligible</option>
                                <option value="2"  @if ($data->severity_rate == 'moderate') selected @endif>Moderate</option>
                                <option value="3" @if ($data->severity_rate == 'major') selected @endif>Major</option>
                                <option value="4"  @if ($data->severity_rate == 'fatal') selected @endif>Fatal</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <select name="Occurrence" id="analysisP" onchange='calculateRiskAnalysis(this)'>
                                <option value="">Enter Your Selection Here</option>
                                <option value="1" @if ($data->Occurrence == 'extremely_unilikely') selected @endif>Extremely Unlikely</option>
                                <option value="2" @if ($data->Occurrence == 'rare') selected @endif>Rare</option>
                                <option value="3" @if ($data->Occurrence == 'unlikely') selected @endif>Unlikely</option>
                                <option value="4" @if ($data->Occurrence == 'likely') selected @endif>Likely</option>
                                <option value="5" @if ($data->Occurrence == 'very_likely') selected @endif>Very Likely</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="group-input">
                            ...
                            <select name="detection" id="analysisN" onchange='calculateRiskAnalysis(this)'>
                                <option value="">Enter Your Selection Here</option>
                                <option value="1" @if ($data->detection == 'impossible') selected @endif>Impossible</option>
                                <option value="2" @if ($data->detection== 'rare') selected @endif>Rare</option>
                                <option value="3" @if ($data->detection == 'unlikely') selected @endif>Unlikely</option>
                                <option value="4"  @if ($data->detection == 'likely') selected @endif>Likely</option>
                                <option value="5" @if ($data->detection == 'very_likely') selected @endif>Very Likely</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-6">
            ...
            <div class="row">
                ...
                <div style="margin-bottom: 0px;" class="col-lg-12 new-date-data-field ">
                    <div class="group-input input-date">
                        ...
                        <select name="source_of_capa" id="failure_investigation_category"
                         @if ($data->stage==4) disabled @endif id="failure_investigation_category" value="{{ $data->source_of_capa }}">
                            <option value="0">-- Select -- </option>
                            <option @if ($data->source_of_capa == 'FailureInvestigation') selected @endif
                                                value="FailureInvestigation">Failure Investigation</option>
            ...
            <div class="inner-block-content">
                <div class="row">
                    ...
                    @if($failureInvestigationExtension && $failureInvestigationExtension->dev_extension_justification)
                        <div class="col-md-12 mb-3">
                            <div class="group-input">
                                <label for="Extension_Justification_failure_investigation">Extension Justification (Failure Investigation)</label>
                                <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                <textarea name="dev_extension_justification" placeholder="Failure Investigation Extension Justification" disabled id="dev_extension_justification" value="{{$failureInvestigationExtension->dev_extension_justification}}">{{$failureInvestigationExtension->dev_extension_justification}}</textarea>
                            </div>
                        </div>
                    @else
                        <div class="col-md-12 mb-3">
                            <div class="group-input">
                                <label for="Extension_Justification_failure_investigation">Extension Justification (Failure Investigation)</label>
                                <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                                <textarea name="dev_extension_justification" placeholder="Failure Investigation Extension Justification" id="dev_extension_justification" disabled ></textarea>
                            </div>
                        </div>
                    @endif
                    ...
                    @if($failureInvestigationExtension && $failureInvestigationExtension->dev_extension_completed_by)
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label for=" dev_extension_completed_by"> Failure Investigation Extension Completed By </label>
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            <label for="Effectiveness_Check_Plan_failure_investigation">Effectiveness Check Plan(Failure Investigation)</label>
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny" name="Effectiveness_Check_Plan_failure_investigation" id="summernote-10"> </textarea>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label for=" failure_investigation_Effectiveness_Check_Plan_Proposed_By">Failure Investigation Effectiveness Check
                        ...
                        <div class="col-lg-6 new-date-data-field">
                            <div class="group-input input-date">
                                <label for="failure_investigation_EC_Plan_Proposed_On"> Failure Investigation Effectiveness Check Plan Proposed
                                    On</label>
                                <div class="calenderauditee">
                    ...
                    <div class="col-md-12 mb-3">
                        <div class="group-input">
                            ...
                            <div><small class="text-primary">Please insert "NA" in the data field if it does not require
                                    completion</small></div>
                            <textarea class="tiny" name="EC_Closure_comments_failure_investigation" id="summernote-10"> </textarea>
                        </div>
                    </div>
                    <div class="col-lg-6 new-date-data-field">
                        <div class="group-input input-date">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="group-input">
                                <label for=" deviaiton_EC_Closed_By">Failure Investigation Effectiveness Check Closed By</label>
                        ...
                        <div class="col-lg-6 new-date-data-field">
                            <div class="group-input input-date">
                                <label for="failure_investigation_Effectiveness_Check_Closed_On">Failure Investigation Effectiveness Check Closed
                                    On</label>
                                <div class="calenderauditee">
                                    <input type="text" id="failure_investigation_Effectiveness_Check_Closed_On" readonly
                                        placeholder="DD-MMM-YYYY" />
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-titles">Failure Investigation Workflow</h4>
                    </div>
                            ...
                            <li>
                                <div>
                                    @if($failureInvestigationExtension && $failureInvestigationExtension->counter == 3)
                                        <a>-------</a>
                                    @else
                                        <a href="" data-bs-toggle="modal" data-bs-target="#failure_investigation_extension"> Failure Investigation</a>
                                    @endif
                                </div>
                            </li>
                        </ul>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('launch-extension-qrm', $data->id) }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <input name="failure_investigation_id" id="failure_investigation_id" value="{{$data->id}}" hidden >
...
<div class="modal fade" id="failure_investigation_extension">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('launch-extension-failure-investigation', $data->id) }}" method="post">
                @csrf
                <!-- Modal body -->
                <div class="modal-body">
                    <!-- <div class="group-input">
                    ...
                    <input name="failure_investigation_id" id="failure_investigation_id" value="{{$data->id}}" hidden  >
                    <input name="extension_identifier" id="extension_identifier" value="Failure Investigation"  hidden >
                </div>
    ...
    <div class="modal fade" id="child-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('failure_investigation_child_1', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="group-input">
    ...
    <div class="modal fade" id="more-info-required-modal">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('failure_investigation_reject', $data->id) }}" method="POST">
                    @csrf
                    <!-- Modal body -->
                    <div class="modal-body">
                        <div class="mb-3 text-justify">
