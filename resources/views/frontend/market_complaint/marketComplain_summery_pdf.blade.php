    ...
    <header>
        <table>
            <tr>
                <td class="w-70" style="text-align: center; vertical-align: middle;">
                    ...
                    Market Complain Summary Report
                    </div>
                </td>
                <td class="w-30">
        ...
        <table>
            <tr>
                ...
                <td class="w-40">
                    {{ Helpers::getDivisionName($data->division_id) }}/MC/{{ date('Y') }}/{{ $data->record ? str_pad($data->record, 4, '0', STR_PAD_LEFT) : '' }}
                </td>
                <td class="w-30">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="no-record">
                            No Action Item has been created from this Market Complain.
                        </td>
                    </tr>
                @endforelse
            </tbody>
