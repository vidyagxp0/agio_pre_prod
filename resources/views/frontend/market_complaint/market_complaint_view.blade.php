                ...
                <div class="inner-block-content">
                    <div class="row">
                            ...
                            <div class="col-md-12 mb-3 productionTable">
                                <div class="group-input">
                                    ...
                                    <textarea @if ($data1->Production_Table_Review == 'yes' && $data->stage == 4) required @endif class="summernote Production_Table_Assessment"
                                        @if (
                                            $data->stage == 3 || (isset($data1->Production_Table_Person) && Auth::user()->name != $data1->Production_Table_Person)) readonly @endif name="Production_Table_Assessment" id="summernote-17">{{ $data1->Production_Table_Assessment }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12 mb-3 productionTable">
                                <div class="group-input">
                        ...
                        @if ($data->stage == 3 || $data->stage == 4)
                            ...
                            <div class="col-12 RegulatoryAffair">
                                <div class="group-input">
                                    ...
                                    <div class="file-attachment-field">
                                        <div disabled class="file-attachment-list"
                                            id="RegulatoryAffair_attechment">
                                    ...
                                    <div class="file-attachment-field">
                                        ...
                                        <div class="add-btn">
                                            ...
                                            <input disabled
                                                {{ $data->stage == 0 || $data->stage == 6 ? 'disabled' : '' }}
                                                type="file" id="myfile"
                                                name="RegulatoryAffair_attechment[]"
                                                oninput="addMultipleFiles(this, 'RegulatoryAffair_attechment')"
                                                multiple>
                                        </div>
                                    </div>
                        ...
                        @else
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="group-input">
                                    <label for="Review Completed On4"
>Other's 4 Review Completed On</label>
                                    <input disabled type="date" name="Other4_on" id="Other4_on"
                                        value="{{ $data1->Other4_on }}">
