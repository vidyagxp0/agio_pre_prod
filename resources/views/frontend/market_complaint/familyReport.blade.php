...
<style>
    @page {
        margin: 140px 35px 90px; /* top header, side, bottom footer */
    }
    ...
    /* HEADER */
    header {
        top: -120px; /* match page top margin */
    }

    /* FOOTER */
    footer {
        bottom: -70px; /* match page bottom margin */
    }
...
<body>
            ...
            <div class="border-table">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        @if($prductgigrid->count())
                            @foreach($prductgigrid as $grid)

                                @if(is_array($grid->decoded))
                                    @foreach($grid->decoded as $detail)
                                        <tr>
                                            <td>{{ $productsdetails++ }}</td>
                                            <td>{{ $detail['info_product_name'] ?? '' }}</td>
                                            <td>{{ $detail['info_batch_no'] ?? '' }}</td>
                                            <td>
                                            ...
                                            <td>{{ $detail['info_batch_size'] ?? '' }}</td>
                                            <td>{{ $detail['info_pack_size'] ?? '' }}</td>
                                            <td>{{ $detail['info_dispatch_quantity'] ?? '' }}</td>
                                            <td>{{ $detail['info_remarks'] ?? '' }}</td>
                                        </tr>
                                    @endforeach
                                @endif
            ...
            <div class="border-table">
                ...
                <table>
                    <tr class="table_bg">
                        ...
                        <th class="w-10">Batch No.</th>
                        <th class="w-10">Manufacturing Location</th>
                        <th class="w-10">Remarks</th>
    ...
    @if($Extension->isNotEmpty())
        ...
        <center><h3>Extension Report</h3></center>
    ...
    @if($rca->isNotEmpty())
        @foreach($rca as $data)
            <center><h3>Root cause Analysis Report</h3></center>
