                ...
                <div id="CCForm1" class="inner-block cctabcontent">
                    <div class="inner-block-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="group-input">
                                    <label for="Details Of Nature Market Complaint">Details Of Nature Market Complaint</label>
                                    <div><small class="text-primary">Please insert "NA" in the data field if it does not require completion</small></div>
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="root-cause-first-table" style="width: 120%;">
                                            <thead>
                                                <tr>
                                                    <th>Row #</th>
                                                    <th>Product Name</th>
                            ...
                            <div class="col-12">
                                <div class="group-input">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="traceability_details_details" style="width: %;">
                                            <thead>
                                                <tr>
                                                    <th>Row #</th>
                                                    <th>Product Name</th>
