...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('non_conformance_lunch_extensions', function (Blueprint $table) {
            $table->id();
            $table->integer('non_conformances_id')->nullable();
    ...
    {
        Schema::dropIfExists('non_conformance_lunch_extensions');
    }
};
